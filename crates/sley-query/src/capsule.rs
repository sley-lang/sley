        ...
        let expected = [
            (
                RestrictedQueryCapsuleId::from_bytes([
                    0xc7, 0x65, 0x52, 0xfe, 0x88, 0x16, 0x8a, 0xfe, 0xb1, 0x30, 0xc2, 0x5d, 0x72,
                    0xc0, 0x57, 0xe4, 0x2c, 0x35, 0xbf, 0xc8, 0x21, 0x30, 0x22, 0xde, 0x2b, 0x2c,
                    0x45, 0x85, 0x13, 0xc8, 0x3c, 0xb4,
                ]),
                540,
            ),
            (
                RestrictedQueryCapsuleId::from_bytes([
                    0xcf, 0x77, 0x17, 0x1d, 0x57, 0xcf, 0xd6, 0xe1, 0x34, 0x35, 0x0b, 0xc0, 0xaf,
                    0xc9, 0xa9, 0x36, 0x8e, 0x3e, 0x34, 0xef, 0x60, 0xc6, 0x45, 0x02, 0x9a, 0xee,
                    0x52, 0xd5, 0xbb, 0x5e, 0x16, 0xa5,
                ]),
                816,
            ),
            (
                RestrictedQueryCapsuleId::from_bytes([
                    0x1f, 0x20, 0x7c, 0x5a, 0x27, 0xd8, 0xaf, 0x08, 0x64, 0xa4, 0x15, 0x6f, 0x96,
                    0x07, 0xa9, 0xde, 0x89, 0x3a, 0x45, 0x0e, 0xe5, 0x66, 0xb2, 0x4d, 0x6a, 0x45,
                    0x7f, 0xd6, 0x5f, 0x0c, 0x59, 0x0d,
                ]),
                736,
            ),
            (
                RestrictedQueryCapsuleId::from_bytes([
                    0x45, 0x12, 0xb3, 0x41, 0x27, 0x5b, 0x80, 0x51, 0xba, 0x82, 0x6f, 0xf5, 0x91,
                    0x94, 0xc0, 0xdc, 0xa8, 0x2c, 0xb7, 0x70, 0xeb, 0x31, 0x91, 0xa6, 0xa9, 0x93,
                    0x97, 0x00, 0x9b, 0x1c, 0xa2, 0x92,
                ]),
                672,
            ),
        ];
