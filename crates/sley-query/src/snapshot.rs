...
mod tests {
    ...
    fn empty_and_nonempty_records_have_fixed_vectors() {
        ...
        assert_eq!(
            hex(empty.record()),
            ""
        );
        assert_eq!(
            hex(nonempty.record()),
            ""
        );
        assert_eq!(
            hex(empty.snapshot_id().as_bytes()),
            "a6800e0f84dc7f49adb911dce6e480a104c66fe5c141ab0862c5476c50626c13"
        );
        assert_eq!(
            hex(nonempty.snapshot_id().as_bytes()),
            "3d9cfe439ef184947d9f0b3a98ced9d397796a7d11987ab700cd3998399b9461"
        );
    }
