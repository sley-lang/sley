...
mod tests {
    ...
    use sley_id::{
        CandidateId, CandidateNonce, CandidateResultId, EntityId, ObjectId, PrincipalId,
        ReceiptId,
    };
    use sley_mutate::{
    ...
    struct VisibleRevisionCorruptionFixtureObservation {
        ...
        origin_object_identity: ObjectId,
        head_object_identity: ObjectId,
        origin_object_path: ::std::path::PathBuf,
        head_object_path: ::std::path::PathBuf,
    ...
    fn assert_target_receipt_envelope_plan(plan: &CorruptionFixturePlan) {
        ...
        let expected_leaf_id = match plan.selector {
            "receipt_scb_magic_invalid" => "target_receipt_scb_magic_invalid",
            "receipt_scb_version_unsupported" => {
                "target_receipt_scb_version_unsupported"
            }
            "receipt_scb_digest_mismatch" => "target_receipt_scb_digest_mismatch",
            "receipt_scb_trailing_bytes" => "target_receipt_scb_trailing_bytes",
            "receipt_scb_varint_non_minimal" => {
                "target_receipt_scb_varint_non_minimal"
            }
            "receipt_scb_integer_overflow" => "target_receipt_scb_integer_overflow",
            "receipt_scb_length_overflow" => "target_receipt_scb_length_overflow",
            "receipt_scb_field_missing" => "target_receipt_scb_field_missing",
            "receipt_scb_field_unknown" => "target_receipt_scb_field_unknown",
            "receipt_scb_field_duplicate" => "target_receipt_scb_field_duplicate",
            "receipt_scb_union_invalid" => "target_receipt_scb_union_invalid",
            "receipt_scb_resource_limit" => "target_receipt_scb_resource_limit",
    ...
    fn assert_target_receipt_nested_transaction_plan(plan: &CorruptionFixturePlan) {
        ...
        ::core::assert_eq!(plan.group_id, "target_transaction");
        let expected_leaf_id = match plan.selector {
            "receipt_txn_format_version" => "target_receipt_txn_format_version",
            "receipt_txn_field_shape" => "target_receipt_txn_field_shape",
            "receipt_txn_receipt_binding_mismatch" => {
                "target_receipt_txn_receipt_binding_mismatch"
            }
            "receipt_txn_object_inventory_mismatch" => {
                "target_receipt_txn_object_inventory_mismatch"
            }
            "receipt_txn_kind_invalid" => "target_receipt_txn_kind_invalid",
            "receipt_txn_parent_shape" => "target_receipt_txn_parent_shape",
            "receipt_txn_changed_binding_invalid" => {
                "target_receipt_txn_changed_binding_invalid"
            }
            "receipt_txn_tombstone_invalid" => "target_receipt_txn_tombstone_invalid",
            "receipt_txn_result_not_valid" => "target_receipt_txn_result_not_valid",
            "receipt_txn_result_binding_mismatch" => {
                "target_receipt_txn_result_binding_mismatch"
            }
            "receipt_txn_test_evidence_unsupported" => {
                "target_receipt_txn_test_evidence_unsupported"
            }
            "receipt_txn_genesis_invalid" => "target_receipt_txn_genesis_invalid",
            "codec_txn_resource_limit" => "target_codec_txn_resource_limit",
            selector => {
                ::core::panic!("unsupported receipt-transaction selector: {selector}")
            }
        };
        ::core::assert_eq!(plan.leaf_id, expected_leaf_id);
        ::core::assert_eq!(plan.target_role, "BRANCH_HEAD_REVISION");
    ...
    fn assert_target_receipt_nested_candidate_plan(plan: &CorruptionFixturePlan) {
        ...
        ::core::assert_eq!(plan.group_id, "target_transaction");
        let expected_leaf_id = match plan.selector {
            "candidate_mutation_candidate_format_version" => {
                "target_candidate_mutation_candidate_format_version"
            }
            "candidate_mutation_candidate_expiry_invalid" => {
                "target_candidate_mutation_candidate_expiry_invalid"
            }
            "candidate_mutation_candidate_empty_operations" => {
                "target_candidate_mutation_candidate_empty_operations"
            }
            "candidate_mutation_candidate_operation_ordinal" => {
                "target_candidate_mutation_candidate_operation_ordinal"
            }
            "candidate_mutation_candidate_operation_precondition_ordinal" => {
                "target_candidate_mutation_candidate_operation_precondition_ordinal"
            }
            "candidate_mutation_candidate_precondition_mismatch" => {
                "target_candidate_mutation_candidate_precondition_mismatch"
            }
            "candidate_mutation_candidate_precondition_count" => {
                "target_candidate_mutation_candidate_precondition_count"
            }
            "candidate_mutation_candidate_target_entity" => {
                "target_candidate_mutation_candidate_target_entity"
            }
            "candidate_mutation_candidate_validation_profile" => {
                "target_candidate_mutation_candidate_validation_profile"
            }
    ...
    fn assert_target_receipt_nested_candidate_result_plan(plan: &CorruptionFixturePlan) {
        ...
        let expected_leaf_id = match plan.selector {
            "candidate_result_candidate_result_format_version" => {
                "target_candidate_result_candidate_result_format_version"
            }
            "candidate_result_candidate_result_profile_invalid" => {
                "target_candidate_result_candidate_result_profile_invalid"
            }
            "candidate_result_candidate_result_phase_shape" => {
                "target_candidate_result_candidate_result_phase_shape"
            }
            "candidate_result_candidate_result_decision_phase_mismatch" => {
                "target_candidate_result_candidate_result_decision_phase_mismatch"
            }
            "candidate_result_candidate_result_diagnostic_invalid" => {
                "target_candidate_result_candidate_result_diagnostic_invalid"
            }
            "candidate_result_candidate_result_set_invalid" => {
                "target_candidate_result_candidate_result_set_invalid"
            }
            "candidate_result_candidate_result_candidate_id_shape" => {
                "target_candidate_result_candidate_result_candidate_id_shape"
            }
            "candidate_result_candidate_result_root_shape" => {
                "target_candidate_result_candidate_result_root_shape"
            }
            selector => {
                ::core::panic!("unsupported nested candidate-result selector: {selector}")
            }
        };
        ::core::assert_eq!(plan.leaf_id, expected_leaf_id);
        ::core::assert_eq!(plan.target_role, "BRANCH_HEAD_REVISION");
    ...
    fn assert_target_receipt_nested_state_root_plan(plan: &CorruptionFixturePlan) {
        ...
        ::core::assert_eq!(plan.group_id, "target_transaction");
        let expected_leaf_id = match plan.selector {
            "state_root_scb_digest_mismatch" => "target_state_root_scb_digest_mismatch",
            "state_state_root_entry_unbound" => "target_state_state_root_entry_unbound",
            "state_state_root_flag_unknown" => "target_state_state_root_flag_unknown",
            "state_schema_epoch_mismatch" => "target_state_schema_epoch_mismatch",
    ...
    fn assert_target_receipt_nested_policy_root_plan(plan: &CorruptionFixturePlan) {
        ...
        ::core::assert_eq!(plan.group_id, "target_transaction");
        let expected_leaf_id = match plan.selector {
            "policy_root_scb_digest_mismatch" => "target_policy_root_scb_digest_mismatch",
    ...
    fn assert_target_visible_revision_plan(plan: &CorruptionFixturePlan) {
        match plan.corrupter_class {
            "receipt_envelope" => assert_target_receipt_envelope_plan(plan),
            "receipt_nested_transaction" => {
                assert_target_receipt_nested_transaction_plan(plan)
            }
            "receipt_nested_candidate" => assert_target_receipt_nested_candidate_plan(plan),
            "receipt_nested_candidate_result" => {
                assert_target_receipt_nested_candidate_result_plan(plan)
            }
            "receipt_nested_state_root" => assert_target_receipt_nested_state_root_plan(plan),
            "receipt_nested_policy_root" => assert_target_receipt_nested_policy_root_plan(plan),
            "receipt_semantic_manifest" => assert_target_receipt_semantic_manifest_plan(plan),
            "receipt_absent" => assert_target_receipt_absent_plan(plan),
            "object_bytes" => assert_target_object_bytes_plan(plan),
            class => ::core::panic!("unsupported visible-revision corrupter class: {class}"),
        }
    }
    ...
    fn prepare_visible_revision_corruption_fixture(
        ...
        assert_target_visible_revision_plan(fixture_plan);
        fixture.branches.ensure_layout_under_maintenance().unwrap();
        drop(fixture.branches.acquire_refs_lock().unwrap());
        let source = Fixture::new("cor07-target-visible-revision-source");
        ...
        let selected_branch_name = BranchName::parse("cor07-target-visible-revision").unwrap();
        ...
        let origin_receipt =
            ::sley_txn::import_transaction_receipt(&::std::fs::read(&origin_receipt_path).unwrap())
                .unwrap();
        let head_receipt =
            ::sley_txn::import_transaction_receipt(&::std::fs::read(&head_receipt_path).unwrap())
                .unwrap();
        let origin_object_identity = origin_receipt.record.object_manifest[0].object_id;
        let head_object_identity = head_receipt.record.object_manifest[0].object_id;
        let object_store = ObjectStore::new(fixture.path());
        let origin_object_path = object_store.object_path(origin_object_identity);
        let head_object_path = object_store.object_path(head_object_identity);
        let (fault_path, control_path) = match fixture_plan.artifact_role {
            "revision_receipt" => (head_receipt_path, origin_receipt_path),
            "revision_object" => (head_object_path.clone(), origin_object_path.clone()),
            role => ::core::panic!("unsupported visible-revision artifact role: {role}"),
        };
        ...
        VisibleRevisionCorruptionFixtureObservation {
            ...
            origin_object_identity,
            head_object_identity,
            origin_object_path,
            head_object_path,
            selected_branch_name,
            origin_stage_path,
    ...
    fn receipt_envelope_ranges(
        bytes: &[u8],
    ) -> (
        ::core::ops::Range<::core::primitive::usize>,
        ::core::ops::Range<::core::primitive::usize>,
    ) {
        let trailer_start = bytes.len().checked_sub(32).unwrap();
        let mut cursor = ::sley_scb1::ScbValueCursor::new(&bytes[..trailer_start]).unwrap();
        ::core::assert_eq!(cursor.read_exact_bytes(8).unwrap(), b"SLEYRCP1");
        ::core::assert_eq!(cursor.read_uvar(64).unwrap(), 1);
        let length_start = cursor.position();
        let payload = cursor.read_sized_payload().unwrap();
        let payload_end = cursor.position();
        let payload_start = payload_end.checked_sub(payload.len()).unwrap();
        (length_start..payload_start, payload_start..payload_end)
    }

    fn receipt_record_field_ranges(
        payload: &[u8],
        selected_tag: u64,
    ) -> (
        ::core::ops::Range<::core::primitive::usize>,
        ...
        let mut cursor = ::sley_scb1::ScbValueCursor::new(payload).unwrap();
        let field_count = cursor.read_uvar(64).unwrap();
        for _ in 0..field_count {
            let tag_start = cursor.position();
            let tag = cursor.read_uvar(64).unwrap();
            let tag_end = cursor.position();
            let value = cursor.read_sized_payload().unwrap();
            let value_end = cursor.position();
            let value_start = value_end.checked_sub(value.len()).unwrap();
            if tag == selected_tag {
                return (tag_start..tag_end, value_start..value_end);
            }
        }
        ::core::panic!("receipt record field {selected_tag} is absent")
    }

    fn first_list_payload_range(
        bytes: &[u8],
    ) -> ::core::ops::Range<::core::primitive::usize> {
        let mut cursor = ::sley_scb1::ScbValueCursor::new(bytes).unwrap();
        let item_count = cursor.read_uvar(64).unwrap();
        ::core::assert!(item_count > 0);
        let item = cursor.read_sized_payload().unwrap();
        let item_end = cursor.position();
        let item_start = item_end.checked_sub(item.len()).unwrap();
        item_start..item_end
    }

    fn sized_payload_range(
        bytes: &[u8],
    ) -> ::core::ops::Range<::core::primitive::usize> {
        let mut cursor = ::sley_scb1::ScbValueCursor::new(bytes).unwrap();
        let payload = cursor.read_sized_payload().unwrap();
    ...
    fn transaction_envelope_payload_range(
        bytes: &[u8],
    ) -> ::core::ops::Range<::core::primitive::usize> {
        let trailer_start = bytes.len().checked_sub(32).unwrap();
        let mut cursor = ::sley_scb1::ScbValueCursor::new(&bytes[..trailer_start]).unwrap();
        ::core::assert_eq!(cursor.read_exact_bytes(8).unwrap(), b"SLEYTXN1");
        ::core::assert_eq!(cursor.read_uvar(64).unwrap(), 1);
        let payload = cursor.read_sized_payload().unwrap();
        let payload_end = cursor.position();
        let payload_start = payload_end.checked_sub(payload.len()).unwrap();
    ...
    fn reseal_transaction_envelope(bytes: &mut [u8]) {
        let trailer_start = bytes.len().checked_sub(32).unwrap();
        let transaction_id = TransactionId::derive(&bytes[..trailer_start]);
        bytes[trailer_start..].copy_from_slice(transaction_id.as_bytes());
    }

    fn receipt_nested_transaction_ranges(
        bytes: &[u8],
    ) -> (
        ::core::ops::Range<::core::primitive::usize>,
        ::core::ops::Range<::core::primitive::usize>,
    ) {
        let (_length_range, receipt_payload_range) = receipt_envelope_ranges(bytes);
        let (_tag_range, stored_transaction_range) =
            receipt_record_field_ranges(&bytes[receipt_payload_range.clone()], 3);
        let transaction_wrapper_start =
            receipt_payload_range.start + stored_transaction_range.start;
        let transaction_wrapper_end = receipt_payload_range.start + stored_transaction_range.end;
        let transaction_range =
            sized_payload_range(&bytes[transaction_wrapper_start..transaction_wrapper_end]);
        let transaction_start = transaction_wrapper_start + transaction_range.start;
        let transaction_end = transaction_wrapper_start + transaction_range.end;
        let transaction_payload_range =
            transaction_envelope_payload_range(&bytes[transaction_start..transaction_end]);
        (
            transaction_start..transaction_end,
            transaction_start + transaction_payload_range.start
                ..transaction_start + transaction_payload_range.end,
        )
    }

    fn rebuild_transaction_envelope(record: &[u8]) -> Vec<u8> {
        let mut preimage = Vec::new();
        preimage.extend_from_slice(b"SLEYTXN1");
        ...
        preimage.extend_from_slice(transaction_id.as_bytes());
        preimage
    }

    fn replace_transaction_record_field(
        bytes: &mut Vec<u8>,
        transaction_field_tag: u32,
        replacement: Vec<u8>,
    ) {
        let (transaction_range, transaction_payload_range) =
            receipt_nested_transaction_ranges(bytes);
        let record = replace_record_field(
            &bytes[transaction_payload_range],
            transaction_field_tag,
            replacement,
        );
        let transaction = rebuild_transaction_envelope(&record);
        ::core::assert_eq!(
            &bytes[transaction_range.start..transaction_range.start + 8],
            b"SLEYTXN1",
        );
        replace_receipt_nested_bytes(bytes, 3, &transaction);
    }

    fn union_payload_range(
        bytes: &[u8],
    ) -> (
        ::core::primitive::u32,
        ::core::ops::Range<::core::primitive::usize>,
        ...
        let payload_start = payload_end.checked_sub(payload.len()).unwrap();
        cursor.check_finished().unwrap();
        (tag, payload_start..payload_end)
    }

    fn reseal_receipt_envelope(bytes: &mut [u8]) {
        let trailer_start = bytes.len().checked_sub(32).unwrap();
        let receipt_id = ReceiptId::derive(&bytes[..trailer_start]);
        bytes[trailer_start..].copy_from_slice(receipt_id.as_bytes());
    }
    ...
    fn apply_receipt_envelope_corruption(
        ...
        assert_target_receipt_envelope_plan(fixture_plan);
        let mut bytes = ::std::fs::read(fault_path).unwrap();
        match fixture_plan.selector {
            "receipt_scb_magic_invalid" => bytes[0] ^= 1,
            "receipt_scb_version_unsupported" => bytes[8] = 2,
            "receipt_scb_digest_mismatch" => *bytes.last_mut().unwrap() ^= 1,
            "receipt_scb_trailing_bytes" => bytes.push(0),
            "receipt_scb_varint_non_minimal" => {
                bytes.splice(8..9, [0x81, 0x00]);
            }
            "receipt_scb_integer_overflow" => {
                bytes.splice(
                    8..9,
                    [0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x02],
                );
            }
            "receipt_scb_length_overflow" => {
                let (length_start, length_end, payload_length) = {
                    let trailer_start = bytes.len().checked_sub(32).unwrap();
                    let mut cursor =
                        ::sley_scb1::ScbValueCursor::new(&bytes[..trailer_start]).unwrap();
                    cursor.read_exact_bytes(8).unwrap();
                    cursor.read_uvar(64).unwrap();
                    let length_start = cursor.position();
                    let payload_length = cursor.read_uvar(64).unwrap();
                    (length_start, cursor.position(), payload_length)
                };
                let corrupted_length =
                    ::sley_scb1::encode_uvar(payload_length.checked_add(1).unwrap());
                ::core::assert_eq!(corrupted_length.len(), length_end - length_start);
                bytes.splice(length_start..length_end, corrupted_length);
            }
            "receipt_scb_field_missing" => {
                let (_length_range, payload_range) = receipt_envelope_ranges(&bytes);
                ::core::assert_eq!(bytes[payload_range.start], 9);
                bytes[payload_range.start] = 8;
                reseal_receipt_envelope(&mut bytes);
            }
            "receipt_scb_field_unknown" => {
                let (_length_range, payload_range) = receipt_envelope_ranges(&bytes);
                ::core::assert_eq!(bytes[payload_range.start], 9);
                bytes[payload_range.start] = 10;
                reseal_receipt_envelope(&mut bytes);
            }
            "receipt_scb_field_duplicate" => {
                let (_length_range, payload_range) = receipt_envelope_ranges(&bytes);
                let (tag_range, _value_range) =
                    receipt_record_field_ranges(&bytes[payload_range.clone()], 2);
                ::core::assert_eq!(tag_range.len(), 1);
                bytes[payload_range.start + tag_range.start] = 1;
                reseal_receipt_envelope(&mut bytes);
            }
            "receipt_scb_union_invalid" => {
                let (_length_range, payload_range) = receipt_envelope_ranges(&bytes);
                let (_tag_range, value_range) =
                    receipt_record_field_ranges(&bytes[payload_range.clone()], 4);
                bytes[payload_range.start + value_range.start] = 2;
                reseal_receipt_envelope(&mut bytes);
            }
            "receipt_scb_resource_limit" => {
                let (length_range, _payload_range) = receipt_envelope_ranges(&bytes);
                let corrupted_length = ::sley_scb1::encode_uvar(
                    u64::try_from(::sley_scb1::MAX_STANDALONE_BYTES)
                        .unwrap()
                        .checked_add(1)
                        .unwrap(),
                );
                bytes.splice(length_range, corrupted_length);
            }
            selector => ::core::panic!("unsupported receipt-envelope selector: {selector}"),
        }
    ...
    fn apply_receipt_nested_transaction_corruption(
        _fixture: &Fixture,
        fixture_plan: &CorruptionFixturePlan,
        fault_path: &::std::path::Path,
    ) {
        assert_target_receipt_nested_transaction_plan(fixture_plan);
        let mut bytes = ::std::fs::read(fault_path).unwrap();
        match fixture_plan.selector {
            "receipt_txn_format_version" => {
                let (_length_range, payload_range) = receipt_envelope_ranges(&bytes);
                let (_tag_range, value_range) =
                    receipt_record_field_ranges(&bytes[payload_range.clone()], 1);
                ::core::assert_eq!(value_range.len(), 1);
                ::core::assert_eq!(bytes[payload_range.start + value_range.start], 1);
                bytes[payload_range.start + value_range.start] = 2;
                reseal_receipt_envelope(&mut bytes);
            }
            "receipt_txn_field_shape" => {
                let (_length_range, payload_range) = receipt_envelope_ranges(&bytes);
                let (_tag_range, value_range) =
                    receipt_record_field_ranges(&bytes[payload_range.clone()], 9);
                ::core::assert_eq!(value_range.len(), 1);
                ::core::assert_eq!(bytes[payload_range.start + value_range.start], 1);
                bytes[payload_range.start + value_range.start] = 2;
                reseal_receipt_envelope(&mut bytes);
            ...
            "receipt_txn_receipt_binding_mismatch" => {
                ...
                let (_tag_range, value_range) =
                    receipt_record_field_ranges(&bytes[payload_range.clone()], 2);
                ::core::assert_eq!(value_range.len(), 32);
                bytes[payload_range.start + value_range.start] ^= 1;
                reseal_receipt_envelope(&mut bytes);
            }
            "receipt_txn_object_inventory_mismatch" => {
                let (_length_range, payload_range) = receipt_envelope_ranges(&bytes);
                let (_tag_range, manifest_range) =
                    receipt_record_field_ranges(&bytes[payload_range.clone()], 8);
                let item_range = first_list_payload_range(
                    &bytes[payload_range.start + manifest_range.start
                        ..payload_range.start + manifest_range.end],
                );
                let item_start = payload_range.start + manifest_range.start + item_range.start;
                let item_end = payload_range.start + manifest_range.start + item_range.end;
                let (_tag_range, object_id_range) =
                    receipt_record_field_ranges(&bytes[item_start..item_end], 1);
                ::core::assert_eq!(object_id_range.len(), 32);
                bytes[item_start + object_id_range.start] ^= 1;
                reseal_receipt_envelope(&mut bytes);
            }
            "receipt_txn_kind_invalid" => {
                let (transaction_range, transaction_payload_range) =
                    receipt_nested_transaction_ranges(&bytes);
                let (_tag_range, kind_range) = receipt_record_field_ranges(
                    &bytes[transaction_payload_range.clone()],
                    2,
                );
                ::core::assert_eq!(kind_range.len(), 1);
                let kind_offset = transaction_payload_range.start + kind_range.start;
                ::core::assert_eq!(bytes[kind_offset], 2);
                bytes[kind_offset] = 3;
                reseal_transaction_envelope(&mut bytes[transaction_range]);
                reseal_receipt_envelope(&mut bytes);
            }
            "receipt_txn_parent_shape" => {
                replace_transaction_record_field(
                    &mut bytes,
                    4,
            ...
            "receipt_txn_changed_binding_invalid" => {
                let (_transaction_range, transaction_payload_range) =
                    receipt_nested_transaction_ranges(&bytes);
                let (_tag_range, bindings_range) = receipt_record_field_ranges(
                    &bytes[transaction_payload_range.clone()],
                    14,
                );
                let bindings_start = transaction_payload_range.start + bindings_range.start;
                let bindings_end = transaction_payload_range.start + bindings_range.end;
                let mut bindings = list_payloads(&bytes[bindings_start..bindings_end]);
                ::core::assert_eq!(bindings.len(), 1);
                bindings[0] = replace_record_field(
                    &bindings[0],
                    4,
                    ::sley_scb1::encode_list(&[]).unwrap(),
                );
                replace_transaction_record_field(
                    &mut bytes,
                    14,
                    ::sley_scb1::encode_list(&bindings).unwrap(),
                );
            }
            "receipt_txn_tombstone_invalid" => {
                let repeated = vec![0x42; 32];
                replace_transaction_record_field(
                    &mut bytes,
                    18,
                    ::sley_scb1::encode_list(&[repeated.clone(), repeated]).unwrap(),
                );
            }
            "receipt_txn_result_not_valid" => {
                replace_candidate_result_with_invalid_schema(&mut bytes);
            }
            "receipt_txn_result_binding_mismatch" => {
                let (transaction_range, transaction_payload_range) =
                    receipt_nested_transaction_ranges(&bytes);
                let (_tag_range, candidate_id_range) = receipt_record_field_ranges(
                    &bytes[transaction_payload_range.clone()],
                    9,
                );
                let candidate_option_start =
                    transaction_payload_range.start + candidate_id_range.start;
                let candidate_option_end = transaction_payload_range.start + candidate_id_range.end;
                let (tag, candidate_id_payload_range) =
                    union_payload_range(&bytes[candidate_option_start..candidate_option_end]);
                ::core::assert_eq!(tag, 1);
                ::core::assert_eq!(candidate_id_payload_range.len(), 32);
                bytes[candidate_option_start + candidate_id_payload_range.start] ^= 1;
                reseal_transaction_envelope(&mut bytes[transaction_range.clone()]);
                let transaction_id = TransactionId::derive(
                    &bytes[transaction_range.start..transaction_range.end - 32],
                );
                let (_length_range, receipt_payload_range) = receipt_envelope_ranges(&bytes);
                let (_tag_range, receipt_transaction_id_range) =
                    receipt_record_field_ranges(&bytes[receipt_payload_range.clone()], 2);
                ::core::assert_eq!(receipt_transaction_id_range.len(), 32);
                let receipt_transaction_id_start =
                    receipt_payload_range.start + receipt_transaction_id_range.start;
                let receipt_transaction_id_end =
                    receipt_payload_range.start + receipt_transaction_id_range.end;
                bytes[receipt_transaction_id_start..receipt_transaction_id_end]
                    .copy_from_slice(transaction_id.as_bytes());
                reseal_receipt_envelope(&mut bytes);
            }
            "receipt_txn_test_evidence_unsupported" => {
                replace_transaction_record_field(
                    &mut bytes,
                    16,
                    ::sley_scb1::encode_list(&[vec![0x42; 32]]).unwrap(),
                );
            }
            "receipt_txn_genesis_invalid" => {
                replace_transaction_record_field(
                    &mut bytes,
                    2,
                    ::sley_scb1::encode_uvar(1),
                );
            }
    ...
    fn apply_receipt_nested_digest_corruption(
        fault_path: &::std::path::Path,
        receipt_field_tag: u64,
    ) {
        let mut bytes = ::std::fs::read(fault_path).unwrap();
        let nested_range = receipt_nested_bytes_range(&bytes, receipt_field_tag);
        ::core::assert!(nested_range.len() > 32);
        bytes[nested_range.end - 1] ^= 1;
        reseal_receipt_envelope(&mut bytes);
        write_visible_revision_fixture_file(fault_path, &bytes);
    }

    fn receipt_nested_bytes_range(
        bytes: &[u8],
        receipt_field_tag: u64,
    ) -> ::core::ops::Range<::core::primitive::usize> {
        let (_length_range, receipt_payload_range) = receipt_envelope_ranges(bytes);
        let (_tag_range, nested_wrapper_range) =
            receipt_record_field_ranges(&bytes[receipt_payload_range.clone()], receipt_field_tag);
        let nested_wrapper_start = receipt_payload_range.start + nested_wrapper_range.start;
        let nested_wrapper_end = receipt_payload_range.start + nested_wrapper_range.end;
        let nested_range = sized_payload_range(&bytes[nested_wrapper_start..nested_wrapper_end]);
        nested_wrapper_start + nested_range.start..nested_wrapper_start + nested_range.end
    }

    fn receipt_optional_nested_bytes_range(
        bytes: &[u8],
        receipt_field_tag: u64,
    ) -> ::core::ops::Range<::core::primitive::usize> {
        let (_length_range, receipt_payload_range) = receipt_envelope_ranges(bytes);
        let (_tag_range, option_wrapper_range) =
            receipt_record_field_ranges(&bytes[receipt_payload_range.clone()], receipt_field_tag);
        let option_wrapper_start = receipt_payload_range.start + option_wrapper_range.start;
        let option_wrapper_end = receipt_payload_range.start + option_wrapper_range.end;
        let (tag, option_payload_range) =
            union_payload_range(&bytes[option_wrapper_start..option_wrapper_end]);
        ::core::assert_eq!(tag, 1);
        let option_payload_start = option_wrapper_start + option_payload_range.start;
        let option_payload_end = option_wrapper_start + option_payload_range.end;
        let nested_range = sized_payload_range(&bytes[option_payload_start..option_payload_end]);
        option_payload_start + nested_range.start..option_payload_start + nested_range.end
    }

    fn simple_envelope_payload_range(
        bytes: &[u8],
        expected_magic: &[u8; 8],
    ) -> ::core::ops::Range<::core::primitive::usize> {
        let trailer_start = bytes.len().checked_sub(32).unwrap();
        let mut cursor = ::sley_scb1::ScbValueCursor::new(&bytes[..trailer_start]).unwrap();
        ::core::assert_eq!(cursor.read_exact_bytes(8).unwrap(), expected_magic);
        ::core::assert_eq!(cursor.read_uvar(64).unwrap(), 1);
        let payload = cursor.read_sized_payload().unwrap();
        let payload_end = cursor.position();
        let payload_start = payload_end.checked_sub(payload.len()).unwrap();
    ...
    fn reseal_candidate_envelope(bytes: &mut [u8]) {
        let trailer_start = bytes.len().checked_sub(32).unwrap();
        let candidate_id = CandidateId::derive(&bytes[..trailer_start]);
        bytes[trailer_start..].copy_from_slice(candidate_id.as_bytes());
    }

    fn reseal_candidate_result_envelope(bytes: &mut [u8]) {
        let trailer_start = bytes.len().checked_sub(32).unwrap();
        let candidate_result_id = CandidateResultId::derive(&bytes[..trailer_start]);
        bytes[trailer_start..].copy_from_slice(candidate_result_id.as_bytes());
    }

    fn apply_nested_record_format_version_corruption(
        bytes: &mut [u8],
        ...
        let payload_range =
            simple_envelope_payload_range(&bytes[nested_range.clone()], expected_magic);
        let (_tag_range, version_range) = receipt_record_field_ranges(
            &bytes[nested_range.start + payload_range.start
                ..nested_range.start + payload_range.end],
            1,
        );
        ::core::assert_eq!(version_range.len(), 1);
        let version_offset = nested_range.start + payload_range.start + version_range.start;
        ::core::assert_eq!(bytes[version_offset], 1);
        bytes[version_offset] = 2;
        reseal(&mut bytes[nested_range]);
    }

    fn apply_nested_record_fixed_field_corruption(
        bytes: &mut [u8],
        nested_range: ::core::ops::Range<::core::primitive::usize>,
        expected_magic: &[u8; 8],
        field_tag: u64,
        ...
        let payload_range =
            simple_envelope_payload_range(&bytes[nested_range.clone()], expected_magic);
        let (_tag_range, field_range) = receipt_record_field_ranges(
            &bytes[nested_range.start + payload_range.start
                ..nested_range.start + payload_range.end],
            field_tag,
        );
        ::core::assert_eq!(field_range.len(), 32);
        bytes[nested_range.start + payload_range.start + field_range.start] ^= 1;
        reseal(&mut bytes[nested_range]);
    }

    fn nested_envelope_record_field_range(
        bytes: &[u8],
        nested_range: ::core::ops::Range<::core::primitive::usize>,
        expected_magic: &[u8; 8],
        field_tag: u64,
        ...
        nested_range.start + payload_range.start + field_range.start
            ..nested_range.start + payload_range.start + field_range.end
    }
    ...
    fn replace_record_field(
        ...
        let mut cursor = ::sley_scb1::ScbValueCursor::new(record).unwrap();
        let field_count = cursor.read_uvar(64).unwrap();
        let mut fields = Vec::with_capacity(usize::try_from(field_count).unwrap());
        let mut replacement = Some(replacement);
        for _ in 0..field_count {
            let tag = u32::try_from(cursor.read_uvar(32).unwrap()).unwrap();
            let value = cursor.read_sized_payload().unwrap();
            let value = if tag == selected_tag {
        ...
        cursor.check_finished().unwrap();
        ::core::assert!(replacement.is_none());
        ::sley_scb1::encode_record(&fields).unwrap()
    }

    fn list_payloads(list: &[u8]) -> Vec<Vec<u8>> {
        let mut cursor = ::sley_scb1::ScbValueCursor::new(list).unwrap();
        let item_count = cursor.read_uvar(64).unwrap();
        let mut items = Vec::with_capacity(usize::try_from(item_count).unwrap());
        for _ in 0..item_count {
            items.push(cursor.read_sized_payload().unwrap().to_vec());
        }
        cursor.check_finished().unwrap();
        items
    }
    ...
    fn rebuild_candidate_envelope(record: &[u8]) -> Vec<u8> {
        ...
        preimage.extend_from_slice(candidate_id.as_bytes());
        preimage
    }

    fn rebuild_candidate_result_envelope(record: &[u8]) -> Vec<u8> {
        let mut preimage = Vec::new();
        preimage.extend_from_slice(b"SLEYCRS1");
        preimage.extend_from_slice(&::sley_scb1::encode_uvar(1));
        preimage.extend_from_slice(&::sley_scb1::encode_uvar(
            u64::try_from(record.len()).unwrap(),
        ));
        ...
        preimage.extend_from_slice(candidate_result_id.as_bytes());
        preimage
    }

    fn replace_receipt_optional_nested_bytes(
        bytes: &mut Vec<u8>,
        receipt_field_tag: u32,
        nested_bytes: &[u8],
    ) {
        let (_length_range, payload_range) = receipt_envelope_ranges(bytes);
        let encoded_nested = ::sley_scb1::encode_bytes(nested_bytes).unwrap();
        let encoded_option = ::sley_scb1::encode_union(1, &encoded_nested).unwrap();
        let record = replace_record_field(
            &bytes[payload_range],
            receipt_field_tag,
            encoded_option,
    ...
    fn replace_candidate_record_field(
        bytes: &mut Vec<u8>,
        candidate_field_tag: u32,
        replacement: Vec<u8>,
    ) {
        let nested_range = receipt_optional_nested_bytes_range(bytes, 4);
        let payload_range =
            simple_envelope_payload_range(&bytes[nested_range.clone()], b"SLEYCAN1");
        let record = replace_record_field(
            &bytes[nested_range.start + payload_range.start
                ..nested_range.start + payload_range.end],
            candidate_field_tag,
        ...
        let candidate = rebuild_candidate_envelope(&record);
        replace_receipt_optional_nested_bytes(bytes, 4, &candidate);
    }

    fn replace_candidate_result_record_field(
        bytes: &mut Vec<u8>,
        candidate_result_field_tag: u32,
        replacement: Vec<u8>,
    ) {
        let nested_range = receipt_optional_nested_bytes_range(bytes, 5);
        let payload_range =
            simple_envelope_payload_range(&bytes[nested_range.clone()], b"SLEYCRS1");
        let record = replace_record_field(
            &bytes[nested_range.start + payload_range.start
                ..nested_range.start + payload_range.end],
            candidate_result_field_tag,
            replacement,
        );
        let candidate_result = rebuild_candidate_result_envelope(&record);
        replace_receipt_optional_nested_bytes(bytes, 5, &candidate_result);
    }

    fn replace_candidate_result_with_invalid_schema(bytes: &mut Vec<u8>) {
        let nested_range = receipt_optional_nested_bytes_range(bytes, 5);
        let payload_range =
            simple_envelope_payload_range(&bytes[nested_range.clone()], b"SLEYCRS1");
        let (_tag_range, phases_range) = receipt_record_field_ranges(
            &bytes[nested_range.start + payload_range.start
                ..nested_range.start + payload_range.end],
            7,
        );
        let phases_start = nested_range.start + payload_range.start + phases_range.start;
        let phases_end = nested_range.start + payload_range.start + phases_range.end;
        let mut phases = list_payloads(&bytes[phases_start..phases_end]);
        ::core::assert_eq!(phases.len(), 14);
        for (index, phase) in phases.iter_mut().enumerate() {
            if index == 1 {
                *phase = replace_record_field(phase, 2, ::sley_scb1::encode_uvar(2));
                *phase = replace_record_field(
                    phase,
                    4,
                    ::sley_scb1::encode_union(1, &::sley_scb1::encode_uvar(3)).unwrap(),
                );
            } else if index > 1 {
                *phase = replace_record_field(phase, 2, ::sley_scb1::encode_uvar(3));
                *phase = replace_record_field(
                    phase,
                    3,
                    ::sley_scb1::encode_union(0, &[]).unwrap(),
                );
            }
        }
        let diagnostic = ::sley_scb1::encode_record(&[
            (1, ::sley_scb1::encode_uvar(2)),
            (2, ::sley_scb1::encode_uvar(36_001)),
            (3, ::sley_scb1::encode_union(0, &[]).unwrap()),
            (
                4,
                ::sley_scb1::encode_text("CANDIDATE_VALIDATION_INVALID_SCHEMA").unwrap(),
            ),
            (5, ::sley_scb1::encode_uvar(1)),
            (6, ::sley_scb1::encode_union(0, &[]).unwrap()),
        ])
        .unwrap();
        replace_candidate_result_record_field(bytes, 6, ::sley_scb1::encode_uvar(3));
        replace_candidate_result_record_field(
            bytes,
            7,
            ::sley_scb1::encode_list(&phases).unwrap(),
        );
        replace_candidate_result_record_field(
            bytes,
            8,
            ::sley_scb1::encode_list(&[diagnostic]).unwrap(),
        );
        replace_candidate_result_record_field(
            bytes,
            12,
    ...
    fn replace_one_byte_uvar(
        bytes: &mut [u8],
        range: ::core::ops::Range<usize>,
        from: u8,
        to: u8,
    ) {
        ::core::assert_eq!(range.len(), 1);
        ::core::assert_eq!(bytes[range.start], from);
        bytes[range.start] = to;
    }
    ...
    fn apply_receipt_nested_candidate_corruption(
        ...
        assert_target_receipt_nested_candidate_plan(fixture_plan);
        let mut bytes = ::std::fs::read(fault_path).unwrap();
        match fixture_plan.selector {
            "candidate_mutation_candidate_format_version" => {
                let nested_range = receipt_optional_nested_bytes_range(&bytes, 4);
                apply_nested_record_format_version_corruption(
                    &mut bytes,
                    nested_range,
                    b"SLEYCAN1",
                    reseal_candidate_envelope,
                );
                reseal_receipt_envelope(&mut bytes);
            }
            "candidate_mutation_candidate_expiry_invalid" => {
                let nested_range = receipt_optional_nested_bytes_range(&bytes, 4);
                let expiry_range = nested_envelope_record_field_range(
                    &bytes,
                    nested_range.clone(),
                    b"SLEYCAN1",
                    13,
                );
                let (_tag_range, clock_range) =
                    receipt_record_field_ranges(&bytes[expiry_range.clone()], 1);
                let clock_range = expiry_range.start + clock_range.start
                    ..expiry_range.start + clock_range.end;
                replace_one_byte_uvar(&mut bytes, clock_range, 1, 2);
                reseal_candidate_envelope(&mut bytes[nested_range]);
                reseal_receipt_envelope(&mut bytes);
            }
            "candidate_mutation_candidate_empty_operations" => {
                replace_candidate_record_field(
                    &mut bytes,
                    9,
                    ::sley_scb1::encode_list(&[]).unwrap(),
                );
            ...
            "candidate_mutation_candidate_operation_ordinal" => {
                let nested_range = receipt_optional_nested_bytes_range(&bytes, 4);
                let operations_range = nested_envelope_record_field_range(
                    &bytes,
                    nested_range.clone(),
                    b"SLEYCAN1",
                    9,
                );
                let operation_range = first_list_payload_range(&bytes[operations_range.clone()]);
                let operation_start = operations_range.start + operation_range.start;
                let operation_end = operations_range.start + operation_range.end;
                let (_tag_range, ordinal_range) =
                    receipt_record_field_ranges(&bytes[operation_start..operation_end], 1);
                let ordinal_range = operation_start + ordinal_range.start
                    ..operation_start + ordinal_range.end;
                replace_one_byte_uvar(&mut bytes, ordinal_range, 0, 1);
                reseal_candidate_envelope(&mut bytes[nested_range]);
                reseal_receipt_envelope(&mut bytes);
            }
            "candidate_mutation_candidate_operation_precondition_ordinal" => {
                ...
                let operation_end = operations_range.start + operation_range.end;
                let (_tag_range, ordinal_range) =
                    receipt_record_field_ranges(&bytes[operation_start..operation_end], 7);
                let ordinal_range = operation_start + ordinal_range.start
                    ..operation_start + ordinal_range.end;
                replace_one_byte_uvar(&mut bytes, ordinal_range, 0, 1);
                reseal_candidate_envelope(&mut bytes[nested_range]);
            ...
            "candidate_mutation_candidate_precondition_mismatch" => {
                let nested_range = receipt_optional_nested_bytes_range(&bytes, 4);
                let preconditions_range = nested_envelope_record_field_range(
                    &bytes,
                    nested_range.clone(),
                    b"SLEYCAN1",
                    10,
                );
                let precondition_range =
                    first_list_payload_range(&bytes[preconditions_range.clone()]);
                let precondition_start = preconditions_range.start + precondition_range.start;
                let precondition_end = preconditions_range.start + precondition_range.end;
                let (_tag_range, ordinal_range) =
                    receipt_record_field_ranges(&bytes[precondition_start..precondition_end], 1);
                let ordinal_range = precondition_start + ordinal_range.start
                    ..precondition_start + ordinal_range.end;
                replace_one_byte_uvar(&mut bytes, ordinal_range, 0, 1);
                reseal_candidate_envelope(&mut bytes[nested_range]);
                reseal_receipt_envelope(&mut bytes);
            }
            ...
            "candidate_mutation_candidate_target_entity" => {
                ...
                let operation_start = operations_range.start + operation_range.start;
                let operation_end = operations_range.start + operation_range.end;
                let (_tag_range, target_range) =
                    receipt_record_field_ranges(&bytes[operation_start..operation_end], 4);
                ::core::assert_eq!(target_range.len(), 32);
                bytes[operation_start + target_range.start] ^= 1;
                reseal_candidate_envelope(&mut bytes[nested_range]);
                reseal_receipt_envelope(&mut bytes);
            }
            "candidate_mutation_candidate_validation_profile" => {
                let nested_range = receipt_optional_nested_bytes_range(&bytes, 4);
                apply_nested_record_fixed_field_corruption(
                    &mut bytes,
                    nested_range,
                    b"SLEYCAN1",
                    11,
    ...
    fn apply_receipt_nested_candidate_result_corruption(
        _fixture: &Fixture,
        fixture_plan: &CorruptionFixturePlan,
        fault_path: &::std::path::Path,
    ) {
        assert_target_receipt_nested_candidate_result_plan(fixture_plan);
        let mut bytes = ::std::fs::read(fault_path).unwrap();
        match fixture_plan.selector {
            "candidate_result_candidate_result_format_version" => {
                let nested_range = receipt_optional_nested_bytes_range(&bytes, 5);
                apply_nested_record_format_version_corruption(
                    ...
                    nested_range,
                    b"SLEYCRS1",
                    reseal_candidate_result_envelope,
                );
                reseal_receipt_envelope(&mut bytes);
            }
            "candidate_result_candidate_result_profile_invalid" => {
            ...
            "candidate_result_candidate_result_phase_shape" => {
                let nested_range = receipt_optional_nested_bytes_range(&bytes, 5);
                let phases_range = nested_envelope_record_field_range(
                    &bytes,
                    nested_range.clone(),
                    b"SLEYCRS1",
                    7,
                );
                let phase_range = first_list_payload_range(&bytes[phases_range.clone()]);
                let phase_start = phases_range.start + phase_range.start;
                let phase_end = phases_range.start + phase_range.end;
                let (_tag_range, phase_tag_range) =
                    receipt_record_field_ranges(&bytes[phase_start..phase_end], 1);
                let phase_tag_range =
                    phase_start + phase_tag_range.start..phase_start + phase_tag_range.end;
                replace_one_byte_uvar(&mut bytes, phase_tag_range, 1, 2);
                reseal_candidate_result_envelope(&mut bytes[nested_range]);
                reseal_receipt_envelope(&mut bytes);
            }
            "candidate_result_candidate_result_decision_phase_mismatch" => {
                let nested_range = receipt_optional_nested_bytes_range(&bytes, 5);
                ...
                let mut phases = list_payloads(&bytes[phases_range]);
                ::core::assert_eq!(phases.len(), 14);
                for (index, phase) in phases.iter_mut().enumerate() {
                    if index == 2 {
                        *phase = replace_record_field(
            ...
            "candidate_result_candidate_result_diagnostic_invalid" => {
                let diagnostic = ::sley_scb1::encode_record(&[
                    ...
                    (3, ::sley_scb1::encode_union(0, &[]).unwrap()),
                    (4, ::sley_scb1::encode_text("X").unwrap()),
                    (5, ::sley_scb1::encode_uvar(1)),
                    (6, ::sley_scb1::encode_union(0, &[]).unwrap()),
                ])
                .unwrap();
    ...
    fn schema_root_envelope_ranges(
        bytes: &[u8],
    ) -> (
        ::core::ops::Range<::core::primitive::usize>,
        ::core::ops::Range<::core::primitive::usize>,
        ...
        ::core::assert_eq!(cursor.read_uvar(64).unwrap(), 1);
        cursor.read_uvar(32).unwrap();
        let epoch_start = cursor.position();
        cursor.read_exact_bytes(32).unwrap();
        let epoch_end = cursor.position();
        let payload = cursor.read_sized_payload().unwrap();
        let payload_end = cursor.position();
        let payload_start = payload_end.checked_sub(payload.len()).unwrap();
        cursor.check_finished().unwrap();
        (epoch_start..epoch_end, payload_start..payload_end)
    }

    fn reseal_state_root_envelope(bytes: &mut [u8]) {
        let trailer_start = bytes.len().checked_sub(32).unwrap();
        let state_root = StateRoot::derive(&bytes[..trailer_start]);
        bytes[trailer_start..].copy_from_slice(state_root.as_bytes());
    }

    fn rebuild_state_root_envelope(existing: &[u8], record: &[u8]) -> Vec<u8> {
        ...
        preimage.extend_from_slice(record);
        let state_root = StateRoot::derive(&preimage);
        preimage.extend_from_slice(state_root.as_bytes());
        preimage
    }

    fn replace_state_root_record_field(
        bytes: &mut Vec<u8>,
        state_field_tag: u32,
        replacement: Vec<u8>,
    ) {
        let nested_range = receipt_nested_bytes_range(bytes, 6);
        ...
        let state_root = rebuild_state_root_envelope(&bytes[nested_range], &record);
        replace_receipt_nested_bytes(bytes, 6, &state_root);
    }

    fn reseal_policy_root_envelope(bytes: &mut [u8]) {
        let trailer_start = bytes.len().checked_sub(32).unwrap();
        let policy_root = PolicyRootId::derive(&bytes[..trailer_start]);
    ...
    fn apply_schema_root_epoch_corruption(
        ...
        let (epoch_range, payload_range) =
            schema_root_envelope_ranges(&bytes[nested_range.clone()]);
        let (_tag_range, payload_epoch_range) = receipt_record_field_ranges(
            &bytes[nested_range.start + payload_range.start
                ..nested_range.start + payload_range.end],
            2,
        );
        ::core::assert_eq!(epoch_range.len(), 32);
        ::core::assert_eq!(payload_epoch_range.len(), 32);
        let envelope_epoch_start = nested_range.start + epoch_range.start;
        let payload_epoch_start =
            nested_range.start + payload_range.start + payload_epoch_range.start;
        ::core::assert_eq!(
            &bytes[envelope_epoch_start..envelope_epoch_start + 32],
            &bytes[payload_epoch_start..payload_epoch_start + 32],
        );
        bytes[envelope_epoch_start] ^= 1;
        bytes[payload_epoch_start] ^= 1;
        reseal(&mut bytes[nested_range]);
    }
    ...
    fn apply_receipt_nested_state_root_corruption(
        ...
        assert_target_receipt_nested_state_root_plan(fixture_plan);
        match fixture_plan.selector {
            "state_root_scb_digest_mismatch" => {
                apply_receipt_nested_digest_corruption(fault_path, 6);
            }
            "state_state_root_entry_unbound" => {
                let mut bytes = ::std::fs::read(fault_path).unwrap();
                replace_state_root_record_field(
                    &mut bytes,
                    4,
                    ::sley_scb1::encode_list(&[vec![0x42; 32]]).unwrap(),
                );
            ...
            "state_schema_epoch_mismatch" => {
                let mut bytes = ::std::fs::read(fault_path).unwrap();
                let nested_range = receipt_nested_bytes_range(&bytes, 6);
                apply_schema_root_epoch_corruption(
                    &mut bytes,
                    nested_range,
                    reseal_state_root_envelope,
                );
                reseal_receipt_envelope(&mut bytes);
                write_visible_revision_fixture_file(fault_path, &bytes);
            }
    ...
    fn apply_receipt_nested_policy_root_corruption(
        ...
        assert_target_receipt_nested_policy_root_plan(fixture_plan);
        match fixture_plan.selector {
            "policy_root_scb_digest_mismatch" => {
                apply_receipt_nested_digest_corruption(fault_path, 7);
            }
            "policy_policy_root_version_unsupported" => {
                let mut bytes = ::std::fs::read(fault_path).unwrap();
                let nested_range = receipt_nested_bytes_range(&bytes, 7);
                ...
                ::core::assert_eq!(version_range.len(), 1);
                let version_offset =
                    nested_range.start + payload_range.start + version_range.start;
                ::core::assert_eq!(bytes[version_offset], 1);
                bytes[version_offset] = 2;
    ...
    fn apply_receipt_absent_corruption(
        ...
        assert_target_receipt_absent_plan(fixture_plan);
        let parent = fault_path.parent().unwrap();
    ...
    fn observe_visible_revision_corruption_fixture(
        ...
        VisibleRevisionCorruptionFixtureDirect {
            ...
            selected_role_path: fixture_observation.fault_path.clone(),
            other_role_path: fixture_observation.control_path.clone(),
            origin_object_identity: fixture_observation.origin_object_identity,
            head_object_identity: fixture_observation.head_object_identity,
            origin_object_path: fixture_observation.origin_object_path.clone(),
            head_object_path: fixture_observation.head_object_path.clone(),
        }
    }
    ...
    fn object_store_read_error(
        ...
        ::core::assert_eq!(fault_path, fixture_observation.fault_path);
        ::core::assert_eq!(fault_path, fixture_observation.head_object_path);
        let receipt = ::sley_txn::import_transaction_receipt(
            &::std::fs::read(transaction_receipt_path(
                fixture.path(),
        ...
        let verifier = |bytes: &[u8]| {
            import_entity_object(receipt.state_root.record.schema_epoch_id, bytes)
                .map(|object| object.object_id())
        };
        ObjectStore::new(fixture.path())
            .read(fixture_observation.head_object_identity, &verifier)
            .map(|_| ())
            .map_err(::sley_txn::CommitError::Store)
            .map_err(super::BranchError::Transaction)
    }
    ...
    fn import_receipt_then_verify_revision(
        ...
        ::core::assert_eq!(fault_path, fixture_observation.fault_path);
        let bytes = ::std::fs::read(fault_path).map_err(super::BranchError::Io)?;
        let receipt = ::sley_txn::import_transaction_receipt(&bytes)
            .map_err(::sley_txn::CommitError::Codec)
            .map_err(super::BranchError::Transaction)?;
        ::core::assert_eq!(
        ...
        for entry in &receipt.record.object_manifest {
            let actual_length = ObjectStore::new(fixture.path())
                .bounded_object_len(entry.object_id)
                .map_err(::sley_txn::CommitError::Store)
                .map_err(super::BranchError::Transaction)?;
            if actual_length != entry.stored_length {
                return Err(super::BranchError::Transaction(
                    ::sley_txn::CommitError::Transaction(
                        ::sley_txn::TransactionErrorCode::ObjectInventoryMismatch,
                    ),
                ));
            }
        }
    ...
    fn verify_absent_revision_receipt(
        ...
        ::core::assert_eq!(fault_path, fixture_observation.fault_path);
        match ::std::fs::read(fault_path) {
            Err(error) if error.kind() == ::std::io::ErrorKind::NotFound => {
                Err(super::BranchError::Transaction(
                    ::sley_txn::CommitError::Transaction(
                        ::sley_txn::TransactionErrorCode::RecoveryReceiptIncomplete,
                    ),
                ))
            }
            Err(error) => Err(super::BranchError::Io(error)),
            Ok(_) => Ok(()),
        }
    }
    ...
    fn probe_untargeted_corruption_control(
        ...
        ::core::assert_eq!(control_path, fixture_observation.control_path);
        if control_path == fixture_observation.origin_object_path {
            let receipt = ::sley_txn::import_transaction_receipt(
                &::std::fs::read(transaction_receipt_path(
                    fixture.path(),
                    fixture.genesis_transaction_id,
            ...
            ObjectStore::new(fixture.path())
                .read(fixture_observation.origin_object_identity, &verifier)
                .map(|_| ())
                .map_err(::sley_txn::CommitError::Store)
                .map_err(super::BranchError::Transaction)
        } else {
    ...
    struct GroupedOriginDigestNonancestorFixture {
        m2_branch_origin_path: ::std::path::PathBuf,
        m2_primary_carrier_path: ::std::path::PathBuf,
        m2_primary_origin_computed_digest: [u8; DIGEST_LEN],
        m2_primary_origin_record_digest: [u8; DIGEST_LEN],
        m2_primary_path: ::std::path::PathBuf,
        m2_pristine_primary_bytes: ::std::vec::Vec<u8>,
        m2_pristine_primary_observation: ExactPathSnapshot,
        m2_secondary_canonical_origin_record_bytes: ::std::vec::Vec<u8>,
    ...
    type GroupedRefTargetSecondaryObservation = (
        TransactionId,
        TransactionId,
        TransactionId,
    );

    struct GroupedRefFormatTargetMismatchFixture {
        m2_branch_ref_path: ::std::path::PathBuf,
        m2_primary_carrier_path: ::std::path::PathBuf,
        m2_primary_path: ::std::path::PathBuf,
        m2_primary_ref_format_version: u32,
        m2_pristine_primary_bytes: ::std::vec::Vec<u8>,
        m2_pristine_primary_observation: ExactPathSnapshot,
        m2_secondary_carrier_path: ::std::path::PathBuf,
        m2_secondary_only_observation: GroupedRefTargetSecondaryObservation,
        m2_secondary_only_owner_tree: ExactTreeSnapshot,
        m2_secondary_ref_target_transaction_id: TransactionId,
        m2_secondary_verified_claim_transaction_id: TransactionId,
        m2_secondary_verified_head_transaction_id: TransactionId,
        m2_supported_ref_format_version: u32,
        m2_arguments_1: (),
        m2_arguments_2: (),
    }
    ...
    impl BranchOriginAncestryFixture for GroupedOriginDigestNonancestorFixture {
        fn secondary_origin_transaction_id(&self) -> TransactionId {
            self.m2_secondary_origin_transaction_id
        }
    ...
    trait BranchRecordProbeFixture {
        fn primary_branch_record_path(&self) -> &::std::path::Path;
    }

    impl BranchRecordProbeFixture for GroupedOriginFormatNonancestorFixture {
        fn primary_branch_record_path(&self) -> &::std::path::Path {
            &self.m2_primary_path
        }
    }

    impl BranchRecordProbeFixture for GroupedOriginDigestNonancestorFixture {
        fn primary_branch_record_path(&self) -> &::std::path::Path {
            &self.m2_primary_path
        }
    }

    trait BranchRefProbeFixture {
        fn primary_branch_ref_path(&self) -> &::std::path::Path;
    }

    impl BranchRefProbeFixture for GroupedRefFormatTargetMismatchFixture {
        fn primary_branch_ref_path(&self) -> &::std::path::Path {
            &self.m2_primary_path
        }
    }
    ...
    trait RefTargetBindingFixture {
        ...
        fn verified_head_transaction_id(&self) -> TransactionId;
    }

    impl RefTargetBindingFixture for GroupedRefFormatTargetMismatchFixture {
        fn ref_target_transaction_id(&self) -> TransactionId {
            self.m2_secondary_ref_target_transaction_id
        }

        fn verified_claim_transaction_id(&self) -> TransactionId {
            self.m2_secondary_verified_claim_transaction_id
        }

        fn verified_head_transaction_id(&self) -> TransactionId {
            self.m2_secondary_verified_head_transaction_id
        }
    }
    ...
    fn prepare_grouped_origin_digest_nonancestor_fixture(
        fixture: &Fixture,
    ) -> GroupedOriginDigestNonancestorFixture {
        let base = prepare_grouped_origin_format_nonancestor_fixture(fixture);
        let mut corrupted = base.m2_pristine_primary_bytes.clone();
        let preimage_len = corrupted.len() - DIGEST_LEN;
        let m2_primary_origin_computed_digest =
            digest(BRANCH_DIGEST_DOMAIN, &corrupted[..preimage_len]);
        *corrupted.last_mut().unwrap() ^= 1;
        let mut m2_primary_origin_record_digest = [0_u8; DIGEST_LEN];
        m2_primary_origin_record_digest.copy_from_slice(&corrupted[preimage_len..]);
        ::std::fs::write(&base.m2_primary_path, corrupted).unwrap();
        ::std::fs::File::open(&base.m2_primary_path)
            .unwrap()
            .sync_all()
            .unwrap();
        super::sync_dir(base.m2_primary_path.parent().unwrap()).unwrap();

        GroupedOriginDigestNonancestorFixture {
            m2_branch_origin_path: base.m2_branch_origin_path,
            m2_primary_carrier_path: base.m2_primary_carrier_path,
            m2_primary_origin_computed_digest,
            m2_primary_origin_record_digest,
            m2_primary_path: base.m2_primary_path,
            m2_pristine_primary_bytes: base.m2_pristine_primary_bytes,
            m2_pristine_primary_observation: base.m2_pristine_primary_observation,
            m2_secondary_canonical_origin_record_bytes:
                base.m2_secondary_canonical_origin_record_bytes,
            m2_secondary_carrier_path: base.m2_secondary_carrier_path,
            m2_secondary_only_observation: base.m2_secondary_only_observation,
            m2_secondary_only_owner_tree: base.m2_secondary_only_owner_tree,
            m2_secondary_origin_record_bytes: base.m2_secondary_origin_record_bytes,
            m2_secondary_origin_transaction_id: base.m2_secondary_origin_transaction_id,
            m2_secondary_reachable_transaction_ids:
                base.m2_secondary_reachable_transaction_ids,
            m2_arguments_1: (),
            m2_arguments_2: (),
        }
    }

    fn prepare_grouped_ref_format_target_mismatch_fixture(
        fixture: &Fixture,
    ) -> GroupedRefFormatTargetMismatchFixture {
        let head_transaction_id = fixture.commit_child(88);
        let claim_transaction_id = fixture.commit_child(89);
        let branch_name = "cor07-ref-format";
        fixture
            .branches
            .create_branch(branch_name, fixture.genesis_transaction_id)
            .unwrap();
        ...
        let head_revision = fixture
            ...
            .verified_revision(head_transaction_id)
            .unwrap();
        let claim_revision = fixture
            .transactions
            .verified_revision(claim_transaction_id)
            .unwrap();
        let mut mismatched_record = ref_record(
            &parsed_name,
            resolved_origin.origin.digest,
            &head_revision,
        );
        mismatched_record.head_state_root = claim_revision.state_root().root;
        let mismatched_ref = build_branch_ref(&mismatched_record).unwrap();
        let m2_primary_path = fixture.branches.checked_ref_path(&parsed_name).unwrap();
        ::std::fs::write(&m2_primary_path, &mismatched_ref.stored_bytes).unwrap();
        ::std::fs::File::open(&m2_primary_path)
            .unwrap()
            .sync_all()
            .unwrap();
        ...
        let payload = payload_offset(&corrupted);
        corrupted[payload + 3] = 2;
        rehash(&mut corrupted, REF_DIGEST_DOMAIN);
        ::std::fs::write(&m2_primary_path, corrupted).unwrap();
        ::std::fs::File::open(&m2_primary_path)
            .unwrap()
            .sync_all()
        ...
        GroupedRefFormatTargetMismatchFixture {
            m2_branch_ref_path: m2_primary_path.clone(),
            m2_primary_carrier_path: m2_primary_path.clone(),
            m2_primary_path: m2_primary_path.clone(),
            m2_primary_ref_format_version: 2,
            m2_pristine_primary_bytes,
            m2_pristine_primary_observation,
            m2_secondary_carrier_path: m2_primary_path,
            m2_secondary_only_observation,
            m2_secondary_only_owner_tree,
            m2_secondary_ref_target_transaction_id: head_transaction_id,
            m2_secondary_verified_claim_transaction_id: claim_transaction_id,
            m2_secondary_verified_head_transaction_id: head_transaction_id,
            m2_supported_ref_format_version: RECORD_VERSION,
            m2_arguments_1: (),
            m2_arguments_2: (),
        }
    }
    ...
    fn observe_grouped_origin_digest_nonancestor_fixture_primary(
        _fixture: &Fixture,
        m2_fixture: &GroupedOriginDigestNonancestorFixture,
    ) -> ExactPathSnapshot {
        exact_path_snapshot(&m2_fixture.m2_primary_path)
    }

    fn observe_grouped_origin_digest_nonancestor_fixture_secondary(
        _fixture: &Fixture,
        m2_fixture: &GroupedOriginDigestNonancestorFixture,
    ) -> GroupedOriginFormatSecondaryObservation {
        m2_fixture.m2_secondary_only_observation.clone()
    ...
    fn import_branch_record_error<T: BranchRecordProbeFixture>(
        ...
        let bytes = ::std::fs::read(m2_fixture.primary_branch_record_path())
            .map_err(super::BranchError::Io)?;
        import_branch_record(&bytes)
    }

    fn observe_grouped_ref_format_target_mismatch_fixture_primary(
        _fixture: &Fixture,
        m2_fixture: &GroupedRefFormatTargetMismatchFixture,
    ) -> ExactPathSnapshot {
        exact_path_snapshot(&m2_fixture.m2_primary_path)
    }

    fn observe_grouped_ref_format_target_mismatch_fixture_secondary(
        _fixture: &Fixture,
        m2_fixture: &GroupedRefFormatTargetMismatchFixture,
    ) -> GroupedRefTargetSecondaryObservation {
    ...
    fn probe_ref_target_binding<T: RefTargetBindingFixture>(
        ...
        if m2_fixture.ref_target_transaction_id()
            == m2_fixture.verified_head_transaction_id()
            && m2_fixture.ref_target_transaction_id()
                != m2_fixture.verified_claim_transaction_id()
        {
            ::core::result::Result::Err(super::branch_error(
                super::BranchErrorCode::RefTargetMismatch,
            ))
        } else {
            ::core::result::Result::Ok(())
        }
    ...
    #[test]
    fn cor07_origin_digest_branch_record_digest_mismatch() {
        let fixture = Fixture::new("s20-530-m2-cor-07-origin-digest-branch-record-digest-mismatch");
        let transaction_repository: &::sley_txn::TransactionRepository = &fixture.transactions;
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let m2_fixture = prepare_grouped_origin_digest_nonancestor_fixture(&fixture);
        let m2_branch_origin_path = m2_fixture.m2_branch_origin_path.clone();
        let m2_primary_carrier_path = m2_fixture.m2_primary_carrier_path.clone();
        let m2_primary_origin_computed_digest = m2_fixture.m2_primary_origin_computed_digest.clone();
        let m2_primary_origin_record_digest = m2_fixture.m2_primary_origin_record_digest.clone();
        let m2_primary_path = m2_fixture.m2_primary_path.clone();
        let m2_pristine_primary_bytes = m2_fixture.m2_pristine_primary_bytes.clone();
        let m2_pristine_primary_observation = m2_fixture.m2_pristine_primary_observation.clone();
        let m2_secondary_canonical_origin_record_bytes = m2_fixture.m2_secondary_canonical_origin_record_bytes.clone();
        ...
        let maintenance = branch_repository.acquire_exclusive_maintenance().unwrap();
        ::core::assert_eq!(("primary_origin_path_from_branch", m2_primary_path.as_path()), ("primary_origin_path_from_branch", m2_branch_origin_path.as_path()));
        ::core::assert_ne!(("primary_origin_digest_corrupt", m2_primary_origin_computed_digest), ("primary_origin_digest_corrupt", m2_primary_origin_record_digest));
        ::core::assert_eq!(("secondary_nonancestor_origin_canonical", m2_secondary_origin_record_bytes.as_slice()), ("secondary_nonancestor_origin_canonical", m2_secondary_canonical_origin_record_bytes.as_slice()));
        ::core::assert!(!m2_secondary_reachable_transaction_ids.contains(&m2_secondary_origin_transaction_id), "secondary_origin_not_reachable_from_head");
        ::core::assert_eq!(("same_carrier_origin_semantics", m2_primary_carrier_path.as_path()), ("same_carrier_origin_semantics", m2_secondary_carrier_path.as_path()));
        let m2_primary_probe_before = crate::refs::tests::exact_tree_snapshot(owner_root);
        ...
        let m2_arguments_1 = m2_fixture.m2_arguments_1.clone();
        let m2_before_1 = crate::refs::tests::exact_tree_snapshot(owner_root);
        let m2_primary_before_1 = observe_grouped_origin_digest_nonancestor_fixture_primary(&fixture, &m2_fixture);
        let m2_secondary_before_1 = observe_grouped_origin_digest_nonancestor_fixture_secondary(&fixture, &m2_fixture);
        let m2_result_1 = branch_repository.recover_refs_with_maintenance(&maintenance);
        ::core::assert!(m2_result_1.is_err());
        let m2_error_1 = m2_result_1.expect_err("expected multifault precedence winner");
        let m2_after_1 = crate::refs::tests::exact_tree_snapshot(owner_root);
        let m2_primary_after_1 = observe_grouped_origin_digest_nonancestor_fixture_primary(&fixture, &m2_fixture);
        ...
        ::std::fs::File::open(&m2_primary_path).unwrap().sync_all().unwrap();
        super::sync_dir(m2_primary_path.parent().unwrap()).unwrap();
        let m2_primary_after_repair = observe_grouped_origin_digest_nonancestor_fixture_primary(&fixture, &m2_fixture);
        let m2_secondary_after_repair = observe_grouped_origin_digest_nonancestor_fixture_secondary(&fixture, &m2_fixture);
        let m2_after_repair = crate::refs::tests::exact_tree_snapshot(owner_root);
        ::core::assert_eq!(m2_primary_after_repair, m2_pristine_primary_observation);
        ::core::assert_eq!(m2_secondary_after_repair, m2_secondary_only_observation);
        ::core::assert_eq!(m2_after_repair, m2_secondary_only_owner_tree);
        ...
        let m2_arguments_2 = m2_fixture.m2_arguments_2.clone();
        let m2_before_2 = crate::refs::tests::exact_tree_snapshot(owner_root);
        let m2_primary_before_2 = observe_grouped_origin_digest_nonancestor_fixture_primary(&fixture, &m2_fixture);
        let m2_secondary_before_2 = observe_grouped_origin_digest_nonancestor_fixture_secondary(&fixture, &m2_fixture);
        ::core::assert_eq!(m2_receiver_identity_1, m2_receiver_identity_2);
        ::core::assert_eq!(m2_owner_root_1, m2_owner_root_2);
        ::core::assert_eq!(m2_guard_identity_1, m2_guard_identity_2);
        ::core::assert_eq!(m2_arguments_1, m2_arguments_2);
        ...
        let m2_error_2 = m2_result_2.expect_err("expected multifault precedence loser");
        let m2_after_2 = crate::refs::tests::exact_tree_snapshot(owner_root);
        let m2_primary_after_2 = observe_grouped_origin_digest_nonancestor_fixture_primary(&fixture, &m2_fixture);
    ...
    #[test]
    fn cor07_ref_format_ref_format_version() {
        let fixture = Fixture::new("s20-530-m2-cor-07-ref-format-ref-format-version");
        let transaction_repository: &::sley_txn::TransactionRepository = &fixture.transactions;
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let m2_fixture = prepare_grouped_ref_format_target_mismatch_fixture(&fixture);
        let m2_branch_ref_path = m2_fixture.m2_branch_ref_path.clone();
        let m2_primary_carrier_path = m2_fixture.m2_primary_carrier_path.clone();
        let m2_primary_path = m2_fixture.m2_primary_path.clone();
        let m2_primary_ref_format_version = m2_fixture.m2_primary_ref_format_version.clone();
        let m2_pristine_primary_bytes = m2_fixture.m2_pristine_primary_bytes.clone();
        let m2_pristine_primary_observation = m2_fixture.m2_pristine_primary_observation.clone();
        let m2_secondary_carrier_path = m2_fixture.m2_secondary_carrier_path.clone();
        let m2_secondary_only_observation = m2_fixture.m2_secondary_only_observation.clone();
        let m2_secondary_only_owner_tree = m2_fixture.m2_secondary_only_owner_tree.clone();
        let m2_secondary_ref_target_transaction_id = m2_fixture.m2_secondary_ref_target_transaction_id.clone();
        let m2_secondary_verified_claim_transaction_id = m2_fixture.m2_secondary_verified_claim_transaction_id.clone();
        let m2_secondary_verified_head_transaction_id = m2_fixture.m2_secondary_verified_head_transaction_id.clone();
        let m2_supported_ref_format_version = m2_fixture.m2_supported_ref_format_version.clone();
        let maintenance = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("primary_ref_version_corrupt", m2_primary_ref_format_version), ("primary_ref_version_corrupt", m2_supported_ref_format_version));
        ::core::assert_eq!(("secondary_ref_targets_verified_head", m2_secondary_ref_target_transaction_id), ("secondary_ref_targets_verified_head", m2_secondary_verified_head_transaction_id));
        ...
        let m2_arguments_1 = m2_fixture.m2_arguments_1.clone();
        let m2_before_1 = crate::refs::tests::exact_tree_snapshot(owner_root);
        let m2_primary_before_1 = observe_grouped_ref_format_target_mismatch_fixture_primary(&fixture, &m2_fixture);
        let m2_secondary_before_1 = observe_grouped_ref_format_target_mismatch_fixture_secondary(&fixture, &m2_fixture);
        let m2_result_1 = branch_repository.recover_refs_with_maintenance(&maintenance);
        ::core::assert!(m2_result_1.is_err());
        let m2_error_1 = m2_result_1.expect_err("expected multifault precedence winner");
        let m2_after_1 = crate::refs::tests::exact_tree_snapshot(owner_root);
        let m2_primary_after_1 = observe_grouped_ref_format_target_mismatch_fixture_primary(&fixture, &m2_fixture);
        ...
        ::std::fs::File::open(&m2_primary_path).unwrap().sync_all().unwrap();
        super::sync_dir(m2_primary_path.parent().unwrap()).unwrap();
        let m2_primary_after_repair = observe_grouped_ref_format_target_mismatch_fixture_primary(&fixture, &m2_fixture);
        let m2_secondary_after_repair = observe_grouped_ref_format_target_mismatch_fixture_secondary(&fixture, &m2_fixture);
        let m2_after_repair = crate::refs::tests::exact_tree_snapshot(owner_root);
        ::core::assert_eq!(m2_primary_after_repair, m2_pristine_primary_observation);
        ::core::assert_eq!(m2_secondary_after_repair, m2_secondary_only_observation);
        ::core::assert_eq!(m2_after_repair, m2_secondary_only_owner_tree);
        ...
        let m2_arguments_2 = m2_fixture.m2_arguments_2.clone();
        let m2_before_2 = crate::refs::tests::exact_tree_snapshot(owner_root);
        let m2_primary_before_2 = observe_grouped_ref_format_target_mismatch_fixture_primary(&fixture, &m2_fixture);
        let m2_secondary_before_2 = observe_grouped_ref_format_target_mismatch_fixture_secondary(&fixture, &m2_fixture);
        ::core::assert_eq!(m2_receiver_identity_1, m2_receiver_identity_2);
        ::core::assert_eq!(m2_owner_root_1, m2_owner_root_2);
        ::core::assert_eq!(m2_guard_identity_1, m2_guard_identity_2);
        ::core::assert_eq!(m2_arguments_1, m2_arguments_2);
        ...
        let m2_error_2 = m2_result_2.expect_err("expected multifault precedence loser");
        let m2_after_2 = crate::refs::tests::exact_tree_snapshot(owner_root);
        let m2_primary_after_2 = observe_grouped_ref_format_target_mismatch_fixture_primary(&fixture, &m2_fixture);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_version_unsupported() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-version-unsupported");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_VERSION_UNSUPPORTED"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCB_VERSION_UNSUPPORTED");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_digest_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-digest-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_trailing_bytes() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-trailing-bytes");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_TRAILING_BYTES"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCB_TRAILING_BYTES");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_varint_non_minimal() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-varint-non-minimal");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_VARINT_NON_MINIMAL"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCB_VARINT_NON_MINIMAL");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_integer_overflow() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-integer-overflow");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_INTEGER_OVERFLOW"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCB_INTEGER_OVERFLOW");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_length_overflow() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-length-overflow");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_LENGTH_OVERFLOW"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCB_LENGTH_OVERFLOW");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_field_missing() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-field-missing");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_FIELD_MISSING"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCB_FIELD_MISSING");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_field_unknown() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-field-unknown");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_FIELD_UNKNOWN"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCB_FIELD_UNKNOWN");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_field_duplicate() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-field-duplicate");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_FIELD_DUPLICATE"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCB_FIELD_DUPLICATE");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_union_invalid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-union-invalid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_UNION_INVALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_scb_resource_limit() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-scb-resource-limit");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Scb(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_RESOURCE_LIMIT"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_format_version() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-format-version");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        let fault_before_snapshot = crate::refs::tests::exact_optional_path_snapshot(&fault_path);
        let control_before_snapshot = crate::refs::tests::exact_optional_path_snapshot(&control_path);
        apply_receipt_nested_transaction_corruption(&fixture, &fixture_plan, &fault_path);
        let fault_after_snapshot = crate::refs::tests::exact_optional_path_snapshot(&fault_path);
        let control_after_snapshot = crate::refs::tests::exact_optional_path_snapshot(&control_path);
        let fault_after_kind = fault_after_snapshot.as_ref().map(|snapshot| snapshot.0);
        let fault_before_bytes = fault_before_snapshot.as_ref().map(|snapshot| snapshot.2.clone()).unwrap_or_default();
        ...
        ::core::assert_ne!(("artifact_bytes_or_absence", fault_before_snapshot.clone()), ("artifact_bytes_or_absence", fault_after_snapshot.clone()));
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_FORMAT_VERSION"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_FORMAT_VERSION");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
        ::core::assert_eq!(origin_stage_before_kind, origin_stage_after_kind);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_field_shape() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-field-shape");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_FIELD_SHAPE"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_FIELD_SHAPE");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_receipt_binding_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-receipt-binding-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_RECEIPT_BINDING_MISMATCH"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_RECEIPT_BINDING_MISMATCH");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_object_inventory_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-object-inventory-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_kind_invalid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-kind-invalid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_KIND_INVALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_KIND_INVALID");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_result_binding_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-result-binding-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_RESULT_BINDING_MISMATCH"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_RESULT_BINDING_MISMATCH");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_mutation_candidate_format_version() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-mutation-candidate-format-version");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("artifact_bytes_or_absence", fault_before_snapshot.clone()), ("artifact_bytes_or_absence", fault_after_snapshot.clone()));
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "MUTATION_CANDIDATE_FORMAT_VERSION"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "MUTATION_CANDIDATE_FORMAT_VERSION");
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_result_candidate_result_format_version() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-result-candidate-result-format-version");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        let fault_before_snapshot = crate::refs::tests::exact_optional_path_snapshot(&fault_path);
        let control_before_snapshot = crate::refs::tests::exact_optional_path_snapshot(&control_path);
        apply_receipt_nested_candidate_result_corruption(&fixture, &fixture_plan, &fault_path);
        let fault_after_snapshot = crate::refs::tests::exact_optional_path_snapshot(&fault_path);
        let control_after_snapshot = crate::refs::tests::exact_optional_path_snapshot(&control_path);
        let fault_after_kind = fault_after_snapshot.as_ref().map(|snapshot| snapshot.0);
        let fault_before_bytes = fault_before_snapshot.as_ref().map(|snapshot| snapshot.2.clone()).unwrap_or_default();
        ...
        ::core::assert_ne!(("artifact_bytes_or_absence", fault_before_snapshot.clone()), ("artifact_bytes_or_absence", fault_after_snapshot.clone()));
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "CANDIDATE_RESULT_FORMAT_VERSION"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "CANDIDATE_RESULT_FORMAT_VERSION");
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_mutation_candidate_validation_profile() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-mutation-candidate-validation-profile");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "MUTATION_CANDIDATE_VALIDATION_PROFILE"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "MUTATION_CANDIDATE_VALIDATION_PROFILE");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_result_candidate_result_profile_invalid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-result-candidate-result-profile-invalid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "CANDIDATE_RESULT_PROFILE_INVALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "CANDIDATE_RESULT_PROFILE_INVALID");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_mutation_candidate_expiry_invalid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-mutation-candidate-expiry-invalid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "MUTATION_CANDIDATE_EXPIRY_INVALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "MUTATION_CANDIDATE_EXPIRY_INVALID");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_mutation_candidate_operation_ordinal() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-mutation-candidate-operation-ordinal");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "MUTATION_CANDIDATE_OPERATION_ORDINAL"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "MUTATION_CANDIDATE_OPERATION_ORDINAL");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_mutation_candidate_operation_precondition_ordinal() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-mutation-candidate-operation-precondition-ordinal");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "MUTATION_CANDIDATE_OPERATION_PRECONDITION_ORDINAL"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "MUTATION_CANDIDATE_OPERATION_PRECONDITION_ORDINAL");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_result_candidate_result_phase_shape() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-result-candidate-result-phase-shape");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "CANDIDATE_RESULT_PHASE_SHAPE"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "CANDIDATE_RESULT_PHASE_SHAPE");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_mutation_candidate_precondition_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-mutation-candidate-precondition-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "MUTATION_CANDIDATE_PRECONDITION_MISMATCH"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "MUTATION_CANDIDATE_PRECONDITION_MISMATCH");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_mutation_candidate_target_entity() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-mutation-candidate-target-entity");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "MUTATION_CANDIDATE_TARGET_ENTITY"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "MUTATION_CANDIDATE_TARGET_ENTITY");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_mutation_candidate_empty_operations() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-mutation-candidate-empty-operations");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "MUTATION_CANDIDATE_EMPTY_OPERATIONS"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "MUTATION_CANDIDATE_EMPTY_OPERATIONS");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_mutation_candidate_precondition_count() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-mutation-candidate-precondition-count");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "MUTATION_CANDIDATE_PRECONDITION_COUNT"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "MUTATION_CANDIDATE_PRECONDITION_COUNT");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Candidate(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_result_candidate_result_set_invalid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-result-candidate-result-set-invalid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "CANDIDATE_RESULT_SET_INVALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "CANDIDATE_RESULT_SET_INVALID");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_result_candidate_result_candidate_id_shape() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-result-candidate-result-candidate-id-shape");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "CANDIDATE_RESULT_CANDIDATE_ID_SHAPE"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "CANDIDATE_RESULT_CANDIDATE_ID_SHAPE");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_result_candidate_result_root_shape() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-result-candidate-result-root-shape");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "CANDIDATE_RESULT_ROOT_SHAPE"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "CANDIDATE_RESULT_ROOT_SHAPE");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_result_candidate_result_decision_phase_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-result-candidate-result-decision-phase-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "CANDIDATE_RESULT_DECISION_PHASE_MISMATCH"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "CANDIDATE_RESULT_DECISION_PHASE_MISMATCH");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_candidate_result_candidate_result_diagnostic_invalid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-candidate-result-candidate-result-diagnostic-invalid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::CandidateResult(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "CANDIDATE_RESULT_DIAGNOSTIC_INVALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
    ...
    #[test]
    fn cor07_target_transaction_target_state_state_root_entry_unbound() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-state-state-root-entry-unbound");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("artifact_bytes_or_absence", fault_before_snapshot.clone()), ("artifact_bytes_or_absence", fault_after_snapshot.clone()));
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::StateRoot(::sley_state_root::StateRootError::StateRoot(_))))));
        ...
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::StateRoot(::sley_state_root::StateRootError::StateRoot(_))))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
        ::core::assert_eq!(origin_stage_before_kind, origin_stage_after_kind);
    ...
    #[test]
    fn cor07_target_transaction_target_state_state_root_flag_unknown() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-state-state-root-flag-unknown");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_parent_shape() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-parent-shape");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_PARENT_SHAPE"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_changed_binding_invalid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-changed-binding-invalid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_CHANGED_BINDING_INVALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_CHANGED_BINDING_INVALID");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_tombstone_invalid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-tombstone-invalid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_TOMBSTONE_INVALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_TOMBSTONE_INVALID");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_result_not_valid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-result-not-valid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_RESULT_NOT_VALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_RESULT_NOT_VALID");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_test_evidence_unsupported() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-test-evidence-unsupported");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_TEST_EVIDENCE_UNSUPPORTED"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_TEST_EVIDENCE_UNSUPPORTED");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_receipt_txn_genesis_invalid() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-receipt-txn-genesis-invalid");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_GENESIS_INVALID"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_GENESIS_INVALID");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_codec_txn_resource_limit() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-codec-txn-resource-limit");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_RESOURCE_LIMIT"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ::core::assert_eq!(("fault_path_equals_selected_role_path", fault_path.as_path()), ("fault_path_equals_selected_role_path", fixture_direct.selected_role_path.as_path()));
        ...
        let ref_stage_after_snapshot = crate::refs::tests::exact_path_snapshot(&ref_stage_path);
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "TXN_RESOURCE_LIMIT");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::Transaction(_)))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
    ...
    #[test]
    fn cor07_target_transaction_target_repository_txn_object_inventory_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-repository-txn-object-inventory-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("artifact_bytes_or_absence", fault_before_snapshot.clone()), ("artifact_bytes_or_absence", fault_after_snapshot.clone()));
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Transaction(_))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "TXN_OBJECT_INVENTORY_MISMATCH"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
    ...
    #[test]
    fn cor07_target_transaction_target_repository_recovery_receipt_incomplete() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-repository-recovery-receipt-incomplete");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
    ...
    #[test]
    fn cor07_target_transaction_target_state_root_scb_digest_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-state-root-scb-digest-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("artifact_bytes_or_absence", fault_before_snapshot.clone()), ("artifact_bytes_or_absence", fault_after_snapshot.clone()));
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::StateRoot(::sley_state_root::StateRootError::Scb(_))))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_DIGEST_MISMATCH"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
    ...
    #[test]
    fn cor07_target_transaction_target_policy_root_scb_digest_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-policy-root-scb-digest-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("artifact_bytes_or_absence", fault_before_snapshot.clone()), ("artifact_bytes_or_absence", fault_after_snapshot.clone()));
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::PolicyRoot(::sley_policy::PolicyRootError::Scb(_))))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCB_DIGEST_MISMATCH"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ...
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCB_DIGEST_MISMATCH");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::PolicyRoot(::sley_policy::PolicyRootError::Scb(_))))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
        ::core::assert_eq!(origin_stage_before_kind, origin_stage_after_kind);
    ...
    #[test]
    fn cor07_target_transaction_target_state_schema_epoch_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-state-schema-epoch-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("artifact_bytes_or_absence", fault_before_snapshot.clone()), ("artifact_bytes_or_absence", fault_after_snapshot.clone()));
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::StateRoot(::sley_state_root::StateRootError::Schema(_))))));
        ...
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::StateRoot(::sley_state_root::StateRootError::Schema(_))))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
        ::core::assert_eq!(origin_stage_before_kind, origin_stage_after_kind);
    ...
    #[test]
    fn cor07_target_transaction_target_policy_policy_root_version_unsupported() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-policy-policy-root-version-unsupported");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
    ...
    #[test]
    fn cor07_target_transaction_target_policy_schema_epoch_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-policy-schema-epoch-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
        ...
        ::core::assert_ne!(("artifact_bytes_or_absence", fault_before_snapshot.clone()), ("artifact_bytes_or_absence", fault_after_snapshot.clone()));
        ::core::assert_ne!(("selector_effect", fault_before_snapshot), ("selector_effect", fault_after_snapshot));
        ::core::assert!(::core::matches!((&fixture_probe_error), super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::PolicyRoot(::sley_policy::PolicyRootError::Schema(_))))));
        ::core::assert_eq!(("direct_probe_code", fixture_probe_error.code()), ("direct_probe_code", "SCHEMA_EPOCH_MISMATCH"));
        ::core::assert!(untargeted_probe_result.is_ok(), "untargeted_control");
        ::core::assert_ne!(("origin_head_ids_distinct", fixture_direct.origin_identity), ("origin_head_ids_distinct", fixture_direct.head_identity));
        ::core::assert_ne!(("origin_head_receipt_paths_distinct", fixture_direct.origin_receipt_path.as_path()), ("origin_head_receipt_paths_distinct", fixture_direct.head_receipt_path.as_path()));
        ...
        let ref_stage_after_kind = ref_stage_after_snapshot.0;
        ::core::assert_eq!(error.code(), "SCHEMA_EPOCH_MISMATCH");
        ::core::assert!(::core::matches!(&error, super::BranchError::Transaction(::sley_txn::CommitError::Codec(::sley_txn::TransactionCodecError::PolicyRoot(::sley_policy::PolicyRootError::Schema(_))))));
        ::core::assert_eq!(crate::refs::tests::exact_error_source_chain(&error), ["CommitError", "TransactionCodecError"]);
        ::core::assert_eq!(owner_tree_before_snapshot, owner_tree_after_snapshot);
        ::core::assert_eq!(origin_stage_before_snapshot, origin_stage_after_snapshot);
        ::core::assert_eq!(origin_stage_before_kind, origin_stage_after_kind);
    ...
    #[test]
    fn cor07_target_transaction_target_object_scb_digest_mismatch() {
        let fixture = Fixture::new("s20-530-cor-07-target-transaction-target-object-scb-digest-mismatch");
        let branch_repository: &super::BranchRepository = &fixture.branches;
        let owner_root = branch_repository.root();
        ::core::assert_eq!(owner_root, fixture.path());
        let maintenance: super::RepositoryMaintenanceGuard = branch_repository.acquire_exclusive_maintenance().unwrap();
