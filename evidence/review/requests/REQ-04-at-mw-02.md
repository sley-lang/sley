...
- Baseline tree: `0bcc9c646f110e2e433e8fe3e9b913d49d84c531` (verify: `git rev-parse HEAD` in `/home/dev/sley2`). Earlier rounds reviewed `c5973c9`; the repair delta `c5973c9..0bcc9c6` is in scope.
