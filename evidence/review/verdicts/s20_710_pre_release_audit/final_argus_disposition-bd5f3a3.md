...
| leakage negative controls | `grep -c "greyforge\|/home/\|file://"` = 0 in T52, T54, dossier, register; machine-summary carries 3 pre-existing `/home/dev/…` locator references also present at `facfa86` (out of scope, noted, not introduced here); owner string appears only in `NOTICE`, audit prose, and transcripts — never in leakage-governed JSON evidence |
