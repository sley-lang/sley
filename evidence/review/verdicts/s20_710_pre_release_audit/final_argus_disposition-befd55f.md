...
| leakage negative controls | no `greyforge`/`/home/`/`file://` in leakage-governed JSON evidence beyond the 3 pre-existing `/home/greyforge/…` locator references also present at `facfa86` (out of scope, noted, not introduced here) |
