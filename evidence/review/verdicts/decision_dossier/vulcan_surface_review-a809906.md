...
- `git rev-parse HEAD` = `a809906f78f1bfdb9cde8da4c108c4d692dad297` (matches SCOPE_SHA). Branch main,
  checkout `/home/dev/Work/workspaces/sley2`.
...
Environment for every checker: `SLEY2_MASTER_GOAL=/home/dev/machineresearch/Sley2.0mastergoal.md`.
...
`/tmp/agent-scratch` containing only the
