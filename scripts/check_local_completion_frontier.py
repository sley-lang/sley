...
def main() -> int:
    try:
        ...
        expected_frontier = {
            "status": "S20_300_FULL_IMPLEMENTED_REVIEWS_PENDING_S20_310_FULL_NEXT",
            "goal_complete": False,
            "next_authority_safe_package": "S20-310-FULL-ROOT-BACKED-QUERIES",
        ...
        require_equal(
            ...
            "S20-310-FULL-ROOT-BACKED-QUERIES",
