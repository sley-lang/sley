...
VECTOR = ROOT / "conformance/schema-epoch/v1/bootstrap.json"
...
required = [
    ...
    "returns the original SCB_* result",
    "epoch number must be greater",
    "reproduced evidence digest must equal the draft",
...
if (
    ...
    problems.append("bootstrap fixture checksum differs")
...
result = {
    ...
    "implementation_complete": (ROOT / "crates/sley-schema/Cargo.toml").is_file(),
    "problems": problems,
}
