...
problems.extend(_slice_proof_problems(ROOT, "s20_700_adapter_responses_persistent_fuzz_slice", "scripts/run_adapter_responses_persistent_fuzz.py", ['adapter_responses']))
