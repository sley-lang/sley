...
for marker in [
    "sixteen persistent libFuzzer targets",
    "fifteen scoped persistent Make smoke gates",
...
expected = {
    ...
    "scoped_target_count": 16,
    "scoped_landed_surface_count": 17,
    ...
    "next_dependency_complete_package": "S20-310-FULL-ROOT-BACKED-QUERIES",
}
...
for path, marker in [
    (RESULTS, "sixteen scoped persistent libFuzzer"),
