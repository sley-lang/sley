...
expected = {
    ...
    "next_dependency_complete_package": "S20-740-INDEPENDENT-REVIEW (Council-gated); local hardening continues discretionarily",
}
...
for path, marker in [
    ...
    (AUDIT, "every fixture family is independently checked"),
