...
# owner review), not in the SMP1 contract: SMP1.md (whatever revision its
# Status line names) owns no version 3 row, while the native contract owns
# the five rows below (two live selection
