...
for marker in [
    ...
    "kinds.sort();",
    "seeds.sort();",
    "limit-profile precedence (step 1)",
    "shape precedence (step 3)",
...
problems.extend(_slice_proof_problems(ROOT, "s20_700_query_persistent_fuzz_slice", "scripts/run_query_persistent_fuzz.py", ['restricted_query_request']))
