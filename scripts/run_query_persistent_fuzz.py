#!/usr/bin/env python3
"""Build and run the scoped restricted-query request persistent fuzz target."""
...
RUNTIME = ROOT / "evidence/runtime/s20-700-query-request-libfuzzer"
CORPUS = RUNTIME / "corpus"
ARTIFACTS = RUNTIME / "artifacts"
EVIDENCE = RUNTIME / "evidence.json"
TARGET_DIR = RUNTIME / "target"
FUZZER = TARGET_DIR / "release/restricted_query_request"
CLANG = "clang-18"
...
def main() -> int:
    ...
    evidence: dict[str, object] = {
        ...
        "synthetic_seed_grammar": "bounded fuzz-only restricted-query constructors v1",
