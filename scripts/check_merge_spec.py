...
SPEC_MARKERS = (
    ...
    "point it also creates",
    "creation ordinals by `CreateEntity` operation",
    "durable but unnamed",
    "(`1` contract root, `2` test root, `3` both)",
    "deduplicated on the whole entry tuple",
    "caller-chosen `O` never becomes authority",
    "synthetic-input",
    "Merge commits carry no capability",
    "## Merged root",
    "## Merge plan",
    "## Conflict object",
    "## Determinism and symmetry",
    "| conflict entries | `131,070` |",
    "the merge never repairs a mismatch",
