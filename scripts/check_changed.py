    ...
    json.dumps(
        {
            ...
            "skip_rationale": "M1 canonical-state implementation and scoped exit profiles pass; S20-200 through S20-230, restricted epoch-1 S20-240 through S20-320, immutable descriptor-only S20-340, protected-root/pure-judgment S20-370, and verified-artifact/version-smoke-only S20-600 mechanics are implemented. Executable candidates/mutations, authenticated policy transitions/capability tokens, full-GA semantic surfaces, VM-integrated/live adapters, canonical/persistent execution reports, complete-root/useful cache indexes, nineteen-class root-backed queries, master context capsules with lawful omission/continuation, clone-equivalent profiles, real benchmark trials/accounting, and later product/release gates remain unavailable.",
            "v2_required": False,
            "cache_use": "none",
            "result": "PASS",
        },
