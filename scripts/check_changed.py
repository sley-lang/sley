    ...
    json.dumps(
        {
            ...
            "skip_rationale": "M1 canonical-state implementation and scoped exit profiles pass; S20-200 through S20-230 plus restricted epoch-1 S20-240, S20-250, and S20-260 profiles are implemented, while their full-GA semantic surfaces, VM execution/adapters, complete-root indexes, clone-equivalent profiles, and later product/release gates remain unavailable.",
            "v2_required": False,
            "cache_use": "none",
            "result": "PASS",
        },
