    ...
    json.dumps(
        {
            ...
            "affected_contracts": [
                ...
                "S20-530 frozen 100-row crash-recovery contract and implementation boundary",
            ...
            "skip_rationale": "M1 canonical-state implementation and scoped exit profiles pass; S20-200 through S20-230, restricted epoch-1 S20-240 through S20-320, immutable descriptor-only S20-340, proposal construction S20-350, restricted validation S20-360, protected policy/capability S20-370/S20-380, restricted fixed-head atomic commit S20-390, and native refs S20-500 are implemented. The exact S20-530 recovery contract is frozen, but recursive recovery implementation, full semantic operation and selected-test execution, authenticated policy transitions, full-GA semantic surfaces, VM-integrated/live adapters, canonical persistent execution reports, complete-root query/capsule surfaces, clone-equivalent profiles, real benchmark trials/accounting, operator-approved root licensing, standards SBOM/provenance, and later product/release gates remain unavailable.",
            "v2_required": False,
            "cache_use": "none",
            "result": "PASS",
        },
