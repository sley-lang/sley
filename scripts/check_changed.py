    ...
    json.dumps(
        {
            ...
            "skip_rationale": "M1 canonical-state implementation and scoped exit profiles pass; S20-200 through S20-230 and the restricted epoch-1 S20-240 profile are implemented, while full-GA contract/test semantics, the remaining M2 fingerprint/VM/adapter surface, clone-equivalent profiles, and later product/release gates remain unavailable.",
            "v2_required": False,
            "cache_use": "none",
            "result": "PASS",
        },
