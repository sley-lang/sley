...
problems.extend(_slice_proof_problems(ROOT, "s20_700_context_capsule_persistent_fuzz_slice", "scripts/run_context_capsule_persistent_fuzz.py", ['context_capsule_builder']))
