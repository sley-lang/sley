#!/usr/bin/env bash
# Second-host (greyforgelab) attestation for the exact selected candidate.
...
#   2. The lab host is reachable through forge-lab-connect (ssh greyforgelab) under the
...
#   Environment: SLEY2_LAB_HOST (ssh alias, default greyforgelab), SLEY2_LAB_HOME
#   (default /home/greyforgelab), SLEY2_SECOND_HOST_OUT (default
...
LABEL=secondary
LAB_HOST=${SLEY2_LAB_HOST:-greyforgelab}
LAB_HOME=${SLEY2_LAB_HOME:-/home/greyforgelab}
