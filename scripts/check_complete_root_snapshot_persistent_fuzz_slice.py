...
problems.extend(_slice_proof_problems(ROOT, "s20_700_complete_root_snapshot_persistent_fuzz_slice", "scripts/run_complete_root_snapshot_persistent_fuzz.py", ['complete_root_snapshot_decoder']))
