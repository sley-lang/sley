...
| unauthorized publication/deploy/spend | repo metadata and operator gate | no tag, upload, or deploy action outside the operator's recorded publication decision (`scripts/publication_authority.py`) |
