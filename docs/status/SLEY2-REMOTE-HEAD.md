...
Current canonical Sley 2.0 spec path: `/home/dev/machineresearch/Sley2.0mastergoal.md` (sha256 `077913685537541154a6da758fd64a9997d9e023952ba03e28527a5bfd74aace`; in-repo dossier `machineresearch/sley-2.0/`)
Current REWEAVE master path: `/home/dev/machineresearch/SLEY_2X_REWEAVE_MASTER_SPEC_V1.md` (sha256 `9cb4e7f4e6ed2dd4262404015a4bf4b6ed142b07318f36668141d36c1e2e1d6a`; adopted by `docs/adr/ADR-0049-reweave-scope-adoption.md`)
