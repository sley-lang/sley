...
(ADR-0044 and ADR-0045, reviews pending); the extended VM fuzz lanes cover families E1 through E6, and every fixture family is independently checked by the independent Python oracle: every remaining boundary waits on Council model access, a schema epoch decision, or operator authority. Now
