...
license text, the gated laboratory lane for a second-host attestation, and the
release decision itself, which stays the operator's while the dossier derives
`BLOCKED`. Meanwhile the pending S20-250, S20-510,
