...
| S20-350 | 345 | Merlin | `sley-mutate` | deferred candidate/precondition construction | underbound or opaque-byte candidate | no implementation until S20-345 passes architecture, semantic, and adversarial review | future exact binding/digest/stale-preimage property matrix | M3 blocker; contracts alone cannot construct a candidate |
