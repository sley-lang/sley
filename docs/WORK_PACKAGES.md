...
| S20-350 | 340 | Merlin | `sley-mutate` | deferred candidate/precondition construction | underbound or opaque-byte candidate | no implementation until all-18-kind typed mutation values/codecs and principal/cap-summary/validation-profile/expiry/canonical-record contracts are frozen | future exact binding/digest/stale-preimage property matrix | M3 blocker; S20-340 descriptors alone cannot construct a typed candidate |
