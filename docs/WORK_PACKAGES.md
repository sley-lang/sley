...
| S20-350 | 345 | Merlin | `sley-mutate` | decomposed candidate/precondition construction; closed host-value and typed-binding slices landed | underbound, opaque-byte, or runtime-type-selected candidate | manifest generation closes 18 body structs, 18 entity-body variants, 75 typed field variants, canonical entity-ID sets, and exact closed kinds for all 179 immutable descriptors; binary codecs, preconditions, records, and builder remain deferred | host/binding drift/structure/unit check; future exact codec/digest/stale-preimage matrix | M3 blocker; typed admission alone cannot construct a candidate |
