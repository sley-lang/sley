...
Status: proposed; the S20-710 full-audit contract is a draft at revision 1
with Council review pending; mechanics implemented (2026-09-03) with
deterministic CycloneDX 1.6 and SPDX 2.3 documents, an unsigned in-toto
statement, and the S20-710 audit still blocked
