...
Status: proposed; the S20-620 contract is a draft at revision 7
...
revision 7 re-pins SMP1 revision 15 and S20-300 revision 6 and corrects
the absent-boundary sentence, with its new-delta review pending);
implemented at
