...
Status: proposed; the S20-620 contract is a draft at revision 6
...
that answered the revision 5 REVISE round) with the revision 6 Nabu and
Vulcan reviews PASS and the Ariadne review pending; implemented at
