...
| Thing | Where |
|---|---|
| Repository | `/home/dev/Work/workspaces/sley2`, branch `main`; private `origin` (`sley2.git`); public sanitized mirror is remote `mirror`, unrelated history, never force-pushed. `/home/dev/sley2` is a stale earlier checkout (94+ commits behind); do not resume there. |
...
- `make quick` needs `SLEY2_MASTER_GOAL=/home/dev/machineresearch/Sley2.0mastergoal.md`.
...
- Second host: `secondary-host` over `lab-transport` (`ssh secondary-host`),
