...
- Remotes: `origin` is the private working repository (browse it for the
  latest validated commits); `mirror` is the public sanitized mirror, refreshed
  only by its own pipeline under a publication decision
