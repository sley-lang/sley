...
|---|---|---|---|
| Formatting+clippy+checkers | `make lint` (pinned env, `CARGO_TARGET_DIR=/home/gfarch/.cache/sley-agg-b0e52e00/target`, `UV_OFFLINE=true`) | 0 | PASS at `10becd4d` (fmt clean, 0 clippy warnings, clean tree; tracked lint-report restored after) |
