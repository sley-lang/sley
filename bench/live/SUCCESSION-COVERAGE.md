...
- CORRUPT: (A) superseded (e2e). REVISED 2026-09-23 after Ariadne
  ...
  toward the PACK oracle. OPTION_3 retained. No acceptance is claimed
  until the owner rules whether a judge-side attempt satisfies "attempt
  import" (every arm is denied exchange.import; the legacy arm records
  oracle-side verification) — `CORRUPT-SURFACE-DECISION.md` §4.
  ...
  inaccurate here). Remaining: owner ruling; live-model trial.
