...
def net_total(lines, tax_basis_points):
...
# NEGATIVE MUTATION (missing_caller): caller_quote omitted (candidate migrates
# only two of the three callers).


CALLERS = ("caller_checkout", "caller_refund")
