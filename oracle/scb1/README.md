...
That isolated path covers 61 accepted and 18 rejected vectors for landed,
unambiguous private codec families, including all twenty `TypeExpr` variants
and eleven entity-body records. It deliberately excludes generic `Option<T>`,
`ConstValue`, deferred bodies, aggregate and candidate records, and runtime
surfaces. Its semantic encoding/decoding logic remains Python-only; committed
