...
implemented; the S20-500 native named-ref and branch boundary is implemented
locally against its reviewed contract; Tier 2 and independent implementation
review remain pending. No comparison or merge exists.
...
The S20-500 implementation in `docs/spec/NATIVE_REFS_BRANCHES_V1.md` keeps branch names
